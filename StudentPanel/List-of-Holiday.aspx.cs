...
public partial class StudentPanel_List_of_Holiday : System.Web.UI.Page
{
    ...
    protected void BindCalender()
    {
        ...
        param[2] = new SqlParameter("@stuid", Session["StuRegNo"]);
    ...
    public static getmonths[] BindDbDatePicker(string month)
    {
        ...
        using (SqlConnection con = new SqlConnection(ConfigurationManager.AppSettings["ConnectionString"].ToString()))
        {
            using (SqlCommand cmd = new SqlCommand("[usp_listofholiday]", con))
            {
                ...
                param[2] = new SqlParameter("@stuid", HttpContext.Current.Session["StuRegNo"]);
