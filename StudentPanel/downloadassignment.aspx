<%@ Page Title="" Language="C#" MasterPageFile="~/StudentPanel/student-panel-master.master" AutoEventWireup="true" CodeFile="downloadassignment.aspx.cs" Inherits="StudentPanel_downloadassignment" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $('.viewdocument').click(function () {
                ...
                var url = $('#ctl00_head_forurl').val() + '/BranchPanel/examresult/';
