<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegistrationForm.aspx.cs" Inherits="StudentPanel_RegistrationForm" %>
 ...
 <div style="float:right; width:45%; margin-top:4px;">
   ...
   <div style="margin-top:10px;">
		  ...
		  <left><b> 1.</b>Transfer  Certificate (Original)</left></br>
		   ...
		   <input type="button" onclick="window.print();" style="margin-left:45%" value="Print" />
    </form>
