...
public partial class StudentPanel_RegExam : System.Web.UI.Page
{
    SqlConnection conSchool = new SqlConnection(ConfigurationManager.AppSettings["ConnectionString1"]);
    private string url = "", filename = "", TempRID="";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            if (Convert.ToString(Session["UserRID"]) != "0")
            {
                TempRID = Convert.ToString(Session["UserRID"]);
                if (TempRID == "")
                {
                    TempRID = "0";
                }
                if (Convert.ToInt32(TempRID) > 0)
                {
                    BindAllDDLOfPage();
                    RID = Convert.ToInt32(TempRID);
                    FillDetails();
                }
                else {
                    BindAllDDLOfPage();
    ...
    public void reset()
    {
        btnforupdateorsave.Visible = true;
        btnforupdateorreset.Visible = true;
        ...
        txtstudentdob.Text = "";
        txtstudentUid.Text = "";
        rbtnlistgender.SelectedValue = Convert.ToString(1);
        rbtnlistnationality.SelectedValue = Convert.ToString(0);
        txtreligion.Text = "";
        rbtnlistcast.SelectedValue = Convert.ToString(1);
        ddlapplyingforclass.SelectedValue = Convert.ToString(0);
        txtaddress.Text = "";
        txtcity.Text = "";
        txtstate.Text = "";
        txtpiorzipcode.Text = "";
        txtcountryname.Text = "";
        ddlparenttype.SelectedValue = Convert.ToString(0);
        ...
        ddlpaymentmode.SelectedValue = Convert.ToString(0);
        ...
        txtchkddneftbankname.Text = "";
        txtchkddneftbranchname.Text = "";
        txtchkddneftrefno.Text = "";
        txtchkddneftrefdate.Text = "";
        txtregistrationdate.Text = "";
        btnforgenAdmit.Visible = false;
    }
    public void enable()
    {
        ddlregistrationsession.Enabled = true;
        txtstudentfirstname.Enabled = true;
        txtstudentmiddlename.Enabled = true;
        txtstudentlastname.Enabled = true;
        txtstudentdob.Enabled = true;
        txtstudentUid.Enabled = true;
        rbtnlistgender.Enabled = true;
        rbtnlistnationality.Enabled = true;
        txtreligion.Enabled = true;
        rbtnlistcast.Enabled = true;
        ddlapplyingforclass.Enabled = true;
        txtaddress.Enabled = true;
        txtcity.Enabled = true;
        txtstate.Enabled = true;
        txtpiorzipcode.Enabled = true;
        txtcountryname.Enabled = true;
        ddlparenttype.Enabled = true;
        txtparentfirstname.Enabled = true;
        txtparentmiddlename.Enabled = true;
        txtparentlastname.Enabled = true;
        txtparentmobileno.Enabled = true;
        txtparentemailid.Enabled = true;
        txtregistrationfee.Enabled = true;
        ddlpaymentmode.Enabled = true;
        txtchkddneftbankname.Enabled = true;
        txtchkddneftbranchname.Enabled = true;
        txtchkddneftrefno.Enabled = true;
        txtchkddneftrefdate.Enabled = true;
    ...
    public void disable()
    {
        ...
        txtstudentUid.Enabled = false;
        rbtnlistgender.Enabled = false;
        rbtnlistnationality.Enabled = false;
        txtreligion.Enabled = false;
        rbtnlistcast.Enabled = false;
        ddlapplyingforclass.Enabled = false;
        txtaddress.Enabled = false;
        txtcity.Enabled = false;
        txtstate.Enabled = false;
        txtpiorzipcode.Enabled = false;
        txtcountryname.Enabled = false;
        ddlparenttype.Enabled = false;
        txtparentfirstname.Enabled = false;
        txtparentmiddlename.Enabled = false;
        txtparentlastname.Enabled = false;
        txtparentmobileno.Enabled = false;
        txtparentemailid.Enabled = false;
        txtregistrationfee.Enabled = false;
        ddlpaymentmode.Enabled = false;
        txtchkddneftbankname.Enabled = false;
        txtchkddneftbranchname.Enabled = false;
        txtchkddneftrefno.Enabled = false;
        txtchkddneftrefdate.Enabled = false;
    ...
    protected void btnforupdateorsave_Click(object sender, EventArgs e)
    {
        ...
        if (Count == 0)
        {
            IdStudent = Convert.ToInt16(Objdut.GetScalar("select Isnull(MAX(RID),0)+1 from tbl_studentregistration where Brid=" + Convert.ToInt16(Session["UserBrid"])));
            SqlParameter[] Param = new SqlParameter[39];
            Param[00] = new SqlParameter("@Brid", Convert.ToInt32(ddlBranch.SelectedValue));
            ...
            Param[03] = new SqlParameter("@StudentFirstName", txtstudentfirstname.Text.Trim());
            Param[04] = new SqlParameter("@StudentMiddleName", txtstudentmiddlename.Text.Trim());
            Param[05] = new SqlParameter("@StudentLastName", txtstudentlastname.Text.Trim());
            Param[06] = new SqlParameter("@StudentDOB", txtstudentdob.Text.Trim());
            Param[07] = new SqlParameter("@Gender", rbtnlistgender.SelectedValue);
            Param[08] = new SqlParameter("@Nationality", rbtnlistnationality.SelectedValue);
            Param[09] = new SqlParameter("@CountryName", txtcountryname.Text.Trim());
            ...
            Param[11] = new SqlParameter("@CastCategoryId", rbtnlistcast.SelectedValue);
            Param[12] = new SqlParameter("@CastCategoryName", rbtnlistcast.SelectedItem.Text.Trim());
            Param[13] = new SqlParameter("@ApplyingForClass", Request.Form[ddlapplyingforclass.UniqueID]);
            ...
            Param[15] = new SqlParameter("@City", txtcity.Text.Trim());
            Param[16] = new SqlParameter("@State", txtstate.Text.Trim());
            Param[17] = new SqlParameter("@Pin", txtpiorzipcode.Text.Trim());
            Param[18] = new SqlParameter("@Country", txtcountryname.Text.Trim());           
            ...
            Param[19] = new SqlParameter("@PrimarySelectParentType", Request.Form[ddlparenttype.UniqueID]);
            Param[20] = new SqlParameter("@PrimaryParentFirstName", txtparentfirstname.Text.Trim());
            Param[21] = new SqlParameter("@PrimaryParentMiddleName", txtparentmiddlename.Text.Trim());
            Param[22] = new SqlParameter("@PrimaryParentLastName", txtparentlastname.Text.Trim());
            ...
            Param[23] = new SqlParameter("@PrimaryMobileNo", txtparentmobileno.Text.Trim());
            Param[24] = new SqlParameter("@PrimaryEmailId", txtparentemailid.Text.Trim());
            ...
            Param[25] = new SqlParameter("@RegistrationFee", txtregistrationfee.Text.Trim() == "" ? "0.00" : txtregistrationfee.Text.Trim());
            Param[26] = new SqlParameter("@PaymentMode", ddlpaymentmode.SelectedValue);
            Param[27] = new SqlParameter("@BankName", txtchkddneftbankname.Text.Trim());
            Param[28] = new SqlParameter("@BranchName", txtchkddneftbranchname.Text.Trim());
            Param[29] = new SqlParameter("@ChkRefNo", txtchkddneftrefno.Text.Trim());
            Param[30] = new SqlParameter("@ChkRefDate", txtchkddneftrefdate.Text.Trim());
            Param[31] = new SqlParameter("@RegistrationDate", txtregistrationdate.Text.Trim());
            //Param[97] = new SqlParameter("@Comment", txtcomment.InnerText.Trim());
            Param[32] = new SqlParameter("@intresult", Convert.ToInt32("0"));
            ...
            if (Request.QueryString["RID"] != null)
            {
                ...
                Param[33] = new SqlParameter("@Registration_NoForAdmissionORUpdate", sturegno);
            }
            else
            {
                Param[33] = new SqlParameter("@Registration_NoForAdmissionORUpdate", "");
            }
            Param[34] = new SqlParameter("@Registration_NoForSMS", SqlDbType.VarChar, -1);
            Param[34].Direction = ParameterDirection.Output;
            Param[35] = new SqlParameter("@StudentUID", txtstudentUid.Text.Trim());
            Param[36] = new SqlParameter("@RegNewNo", txtOldRegNo.Text.Trim());
            Param[37] = new SqlParameter("@BloodGroup", "0");
            Param[38] = new SqlParameter("@ExamMode", ddlExamMode.SelectedValue);
            ...
            if (intresult == 1)
            {
                string RID = Convert.ToString(Objdut.GetScalar("Select ISNULL(RID,0) from tbl_StudentRegistration where Registration_No='" + Convert.ToString(Param[34].Value) + "' and Status=1"));
                if (RID == "")
                {
                    RID = "0";
                }
                ...
                {
                    string strUpdate = "";
                    strUpdate = "update Student_Login SET RID=" + RID + ", Registration_No='" + Convert.ToString(Param[34].Value) + "' where UserID=" + Session["UserNewID"] + " and UserName='" + Session["UserName"] + "'";
                    int intUpResult = Convert.ToInt32(Objdut.ExecuteSql(strUpdate));
                    if (intUpResult > 0)
                    {
                        Utility.ViewAlertMessage(this, "Student registration successfully done.");
                        SqlParameter[] ParamForSms = new SqlParameter[2];
                        ParamForSms[0] = new SqlParameter("@RegistrationNo", Convert.ToString(Param[34].Value));
                        ...
                        if (Dt.Rows.Count > 0)
                        {
                            try
                            {
                                System.Threading.Thread ThreadUpdateGrowthMocha = new System.Threading.Thread(delegate()
                                {
                                    ...
                                    {
                                        sendMessageToMobile.SMSsendForSend(Convert.ToString(Dt.Rows[0]["Mobile"]), Convert.ToString(Dt.Rows[0]["SmsContent"]), Session["UserBrid"].ToString());
                                    }
                                });
                ...
                Response.Redirect("RegExam.aspx?RID=" + RID);
                return;
            }
            else if (intresult == 2)
            {
    ...
    public void BindFillUser()
    {
        if (Session["UserName"] != null)
        {
            string str = "SELECT ISNULL(ClassID,0) ClassID,ISNULL(RID,0) RID,[UserID],[FirstName],[MiddleName],[LastName],[MobNo],[ParentTypeID],[ParentName] " +
                         " ,[Fyid],[Brid],[GenderID],[dob],[UserName],[Password] FROM [student_login] " +
                         " where UserName='" + Session["UserName"].ToString() + "' and UserID ='" + Session["UserNewID"].ToString() + "'";
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                txtstudentfirstname.Text = dt.Rows[0]["FirstName"].ToString();
                txtstudentmiddlename.Text = dt.Rows[0]["MiddleName"].ToString();
                txtstudentlastname.Text = dt.Rows[0]["LastName"].ToString();
                BindParentType();
                ddlparenttype.SelectedValue = dt.Rows[0]["ParentTypeID"].ToString();
                txtparentfirstname.Text = dt.Rows[0]["ParentName"].ToString();
                txtparentmobileno.Text = dt.Rows[0]["MobNo"].ToString();
                txtstudentdob.Text = Convert.ToDateTime(dt.Rows[0]["dob"]).ToString("dd MMMM yyyy");
            }
        }
    }
    ...
    {
        //CommonClassCommonClass= new CommonClass_SH();
        //ddlHouse.DataSource = CommonClass_SH.Dll("GetHouse", Convert.ToInt32(Session["StudentBrid"]));
    ...
    {
        DataTable Dt = new DataTable();
        Dt = CommonClass.ABC("GetClassDDL", Convert.ToInt32(ddlregistrationsession.SelectedValue), Convert.ToInt32(Session["UserBrid"]));
        if (Dt.Rows.Count > 0)
        {
    ...
    public void BindBloodGroup()
    {
        //CommonClassCommonClass= new CommonClass_SH();
        //DataTable Dt = new DataTable();
        //Dt = CommonClass_SH.Dll("GetBloodGroupDDL");
        //if (Dt.Rows.Count > 0)
        //{
    ...
    public void BindsecondaryParentType()
    {
        //CommonClassCommonClass= new CommonClass_SH();
        //DataTable Dt = new DataTable();
        //Dt = CommonClass_SH.Dll("GetParentType");
        //if (Dt.Rows.Count > 0)
        //{
    ...
    public void BindQualification()
    {
        //CommonClassCommonClass= new CommonClass_SH();
        //DataTable Dt = new DataTable();
        //Dt = CommonClass_SH.Dll("GetQualificationDDL");
        //if (Dt.Rows.Count > 0)
        //{
    ...
    {
        DataUtility Objdut = new DataUtility();
        string Query = "Select Convert(Decimal(10,2),Fees) From classfee_master Where Brid=" + HttpContext.Current.Session["UserBrid"] + " And Fyid=" + Fyid + " And Status=1 And FeeId=(Select Id From feestructure Where Fyid=" + Fyid + " And Status=1 And Id=6)";
    ...
    {
        int BRID = Convert.ToInt32(Objdut.GetScalar("Select ISNULL(BRID,0) from tbl_StudentRegistration where RID='" + Convert.ToString(Session["UserBrid"]) + "' and Status=1"));
        if (BRID > 0)
        {
            SqlParameter[] param = new SqlParameter[3];
            param[0] = new SqlParameter("@mode", 2);
            param[1] = new SqlParameter("@Brid", BRID.ToString());
            param[2] = new SqlParameter("@studenregistrationid", RID);
            DataTable Dt = Objdut.GetDataTableSP(param, "usp_studentregistrationlist");
            if (Dt.Rows.Count > 0)
            {
                btnforupdateorsave.Visible = false;
                btnforupdateorreset.Visible = false;
                btnforgenAdmit.Visible = true;                
                BindAllDDLOfPage(); ;
                ddlregistrationsession.SelectedValue = Convert.ToString(Dt.Rows[0]["Fyid"]);
                ddlregistrationsession.Enabled = false;
                ddlExamMode.SelectedValue = Convert.ToString(Dt.Rows[0]["ExamMode"]);
                ...
                txtcountryname.Text = Convert.ToString(Dt.Rows[0]["Country"]);
            ...
            {
                btnforgenAdmit.Visible = false;
                Response.Redirect("student-panel-home-page.aspx");
            }
        }
    }
    ...
    {
        DataTable Dt;
        Dt = CommonClass.ABC("GetClassDDL", Convert.ToInt32(Fyid), Convert.ToInt32(HttpContext.Current.Session["UserBrid"]));
    ...
    protected void btnforgenAdmit_Click(object sender, EventArgs e)
    {       
        Page.ClientScript.RegisterStartupScript(
        this.GetType(), "OpenWindow", "window.open('AdmitCard.aspx','_newtab');", true);
    }
}