<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdmitCard.aspx.cs" Inherits="StudentPanel_AdmitCard" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="printablediv">
            ...
            <div style="width: 680px; min-height: 450px; position:relative; margin: auto auto 60px; margin-bottom: 35px;  border-bottom: 1px dashed rgb(157, 157, 157);">
                ...
                <h3 style=" text-align:center; font-size:18px; margin:10px 0 0;  font-family:Arial; color:#656d70;">Admin Card</h3>
  ...
  <p style="font-size:14px; float:left; font-family:Arial; color:#424546; width:81px; margin:3px 0 10px;">Exam Date</p>
  <dl style="float: left;
    font-size: 13px;
    font-family: Arial;
    color: #424546;
    ...
    font-weight: 600;
    border-bottom: 1px dotted #5f6162;
    width: 25%;"><span id="Span4" runat="server" >0</span>&nbsp;</dl>

                 <p style="font-size:14px; float:left; font-family:Arial; color:#424546; width:45px; margin:4px 0 10px;">Time. </p>
  <dl style="float:left; font-size:13px;  font-family:Arial; color:#424546; font-weight:600;  margin:3px 1% 0 0; border-bottom:1px dotted #5f6162; width:27%;"> <span id="Span2" runat="server">0</span></dl>
  <div style="clear:both;"></div>
  ...
  <p style="font-size:14px; float:left; font-family:Arial; color:#424546; width:100px; margin:3px 0 10px;">Exam Type : </p>
  <dl style="float: left;
    font-size: 13px;
    font-family: Arial;
    color: #424546;
 ...
 HeaderStyle-CssClass="header" RowStyle-CssClass="rows">
                ...
                <div style="font-size: 14px; text-align: right; font-family: Arial; color: #424546; min-width: 630px; width: auto;" runat="server" id="Div2" visible="false">
                ...
                <div visible="false" style="font-size: 14px; text-align: right; font-family: Arial; color: #424546; min-width: 630px; width: auto;" runat="server" id="DueAmount">
                    <table style="float:right; width:100%; border: solid 2px;">                       
                        <tr>
                ...
                <br />
           <p style="font-size:14px; float:left; display:none; font-family:Arial; color:#424546;min-width:630px;width:auto; margin:3px 0 10px;">The Sum of <b> Rs.<span id="Span5" runat="server" ></span>/-</b> (Including <b>Rs.<span id="spantaxamount" runat="server">0</span>/- (<span id="spantaxpercentage" runat="server">0%</span>)</b> Service TAX)</p>

    <div style="clear:both;"></div>

    <p style="font-size:14px; float:left; display:none; font-family:Arial; color:#424546; width:56px; margin:3px 0 10px;">In words</p>
  <dl style="float:left; font-size:13px; display:none;  font-family:Arial; color:#424546; margin:3px 0 10px; font-weight:600; border-bottom:1px solid #5f6162; width:91.5%;"><span id="Span6" runat="server"></span></dl>

    <div style="clear:both;"></div>

    <p style="font-size:14px; float:left; display:none; font-family:Arial; color:#424546; width:106px; margin:3px 0 10px;">Payment Mode:</p>
    <dl style="float:left; font-size:13px; display:none;  font-family:Arial; color:#424546; margin:3px 0 0px; font-weight:600;  width:25%;"><span id="Span7" runat="server"></span></dl>

    <p style="font-size:14px; display:none; float:left; font-family:Arial; color:#424546; width:135px; margin:3px 0 10px;">Bank TransactionID :</p>
    <dl style="float:left; font-size:13px; display:none; font-family:Arial; color:#424546; margin:3px 0 0px; font-weight:600;  width:38%;"><span id="Span10" runat="server" ></span></dl>
     <div style="clear:both;"></div>
...
<dl style="font-size:23px; height:1px; text-align:center;  font-family:Arial; color:#424546; font-weight:600;"><span id="Span17" runat="server"></span></dl>
           <div style="border-bottom:1px solid #e0dfdf; min-height:58px; padding-bottom:4px;">
                ...
                <div id="Div1" class="receiptwrapper_add" runat="server" style="float:right; font-size:12px;  font-family:Arial; color:#656d70;">
                 ...
                 <h3 style=" text-align:center; font-size:18px; margin:10px 0 0;  font-family:Arial; color:#656d70;">Admit Card</h3>
