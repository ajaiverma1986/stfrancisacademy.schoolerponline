...
<head runat="server">
    ...
    <title>BLS Collage/Institute Management Software</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <style type="text/css">
            .for_sigle_row_form input[type="text"] {
            height:33px;
                ...
                <div class="container">
                    <div class="row" style="margin: 0">
                        <div class="col-sm-2" style="">
                            <div style="padding: 5px 5px 0; text-align:center;" id="divforlogo" runat="server">
                                <asp:Image ID="btnlogoforrecipt" runat="server" Width="45%" />
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6" style="text-align: center;">
                            ...
                            <br />
                            <span id="insaddress" runat="server" style="font-size: 12px; font-weight: 700; text-align: center; font-family: Arial; color: #424546;">
                    ...
                    <div class="main-div-tbl" style="">
                        ...
                        <asp:Label runat="server" ID="lblStateMsg" EnableViewState="false" ForeColor="Chocolate"
                            ...
                            <div class="clear"></div>
                            <div id="divs" runat="server" style="display: inline-block; width:100%">
