<%@ Page Language="C#" AutoEventWireup="true" CodeFile="user-login.aspx.cs" Inherits="user_login" %>
                        ...
                        <asp:Panel ID="Panelotp" runat="server">
                            <div class="username">
                                <div class="usernameinner">
                                    <asp:TextBox ID="txtUserName" runat="server" AutoCompleteType="Disabled" autocomplete="off" class="field required" placeholder="Enter Username" title="Please provide your username"></asp:TextBox>
                                </div>
                            </div>
                            <div class="password">
                                <div class="passwordinner">
                                    <asp:TextBox ID="txtPassword" runat="server" AutoCompleteType="Disabled" TextMode="Password" autocomplete="off" CssClass="field required colorblkack" placeholder="Enter Password" title="Password is required" MaxLength="20"></asp:TextBox>
                                </div>
                            </div>
