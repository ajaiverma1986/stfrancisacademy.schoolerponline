...
public class DataUtility
{
    ...
    public double ExecuteSqlSPD(SqlParameter[] arrParam, string strSPName)
    {
        OpenConnection();
        _mDataCom.CommandType = CommandType.StoredProcedure;
        _mDataCom.CommandText = strSPName;
        ...
        _mDataCom.ExecuteNonQuery();
        double dobResult = double.Parse(_mDataCom.Parameters["@dobResult"].Value.ToString());
        CloseConnection();
        DisposeConnection();
        return dobResult;
    }
    ...
    public DataTable GetDataTable(string strSql)
    {
        ...
        _mDataCom.CommandType = CommandType.Text;
        _mDataCom.CommandText = strSql;
        _mDataCom.CommandTimeout = 50000;
    ...
    private bool checkNull(object val)
    {
        bool valid = false;
        valid = (val) != null ? true : false;
        return valid;
    }
