<%@ Page Title="" Language="C#" MasterPageFile="~/ParentPanel/MasterPage.master"
    AutoEventWireup="true" CodeFile="ChangePassword.aspx.cs" Inherits="ParentPanel_ChangePassword" %>
    ...
    <div class="content_pane_cont input_content" id="contentPane">
        ...
        <div class="for_sigle_row_form">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtoldpwd"
                Display="Dynamic" ErrorMessage="Please Enter Old Password" CssClass="rqd"></asp:RequiredFieldValidator>
        </div>
        <div class="for_sigle_row_form">
            <label>
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtnewpwd"
                Display="Dynamic" ErrorMessage="Please Enter New Password" CssClass="rqd"></asp:RequiredFieldValidator>
        </div>
        <div class="for_sigle_row_form">
            <label>
        ...
        <div class="for_sigle_row_form">
            ...
            <asp:Button ID="btnUpdateCancel" runat="server" CausesValidation="false" Text="Cancel"
                CssClass="button2"></asp:Button>
