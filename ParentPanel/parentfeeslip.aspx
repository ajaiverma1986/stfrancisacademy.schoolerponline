<%@ Page Title="" Language="C#" MasterPageFile="~/ParentPanel/MasterPage.master" AutoEventWireup="true" CodeFile="parentfeeslip.aspx.cs" Inherits="ParentPanel_parentfeeslip" %>
        ...
        <div class="tab-content" id="pp">
            <div style="margin: 0px auto; width: 700px;">
                                            ...
                                            <asp:TemplateField>
                                                ...
                                                <FooterTemplate>
                                                    <table width="100%" cellpadding="0px" style="margin-left: -10px;">
                                                        <tr style="font-weight: bold">
                                                            <td>Rs.
                                                                <asp:Label ID="lblTotalcredit" runat="server">0.00</asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr style="font-weight: bold">
                                                            <td>Rs.
                                                        ...
                                                        <tr style="font-weight: bold">
                                                            <td>Rs.
                                                                <asp:Label ID="lblTotalbal" runat="server">0.00</asp:Label>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </FooterTemplate>
                ...
                <table width="100%" cellpadding="0px" style="margin-left: 10px;">
                    ...
                    <tr>
                        <td colspan="2">
                            <strong>Awapal Solutions Pvt. Ltd.</strong>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">&nbsp;
