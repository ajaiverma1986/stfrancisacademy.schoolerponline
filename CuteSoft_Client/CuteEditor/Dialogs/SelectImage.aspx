...
<head runat="server">
    ...
    <script type="text/javascript">
        var OxO3518 = []; function PostBackAction() {<%=Page.ClientScript.GetPostBackEventReference(hiddenAction,"")%>; };
    </script>
    <style type="text/css">
        #browse_Frame {
                    ...
                    <td>
                        ...
                        <fieldset id="fieldsetUpload">
                            ...
                            <table>
                                ...
                                <tr>
                                    <td>
                                        <img class="image-align" alt="" src="../Load.ashx?type=image&file=colorfocus.gif" /></td>
