...
<head>
    ...
    <script type="text/javascript">
        var OxO3845 = []; function PostBackAction() {<%=Page.ClientScript.GetPostBackEventReference(hiddenAction,"")%>; };
    </script>
    <style type="text/css">
        #browse_Frame {
                            ...
                            <div style="padding: 3px;">
                                <table border="0" cellpadding="1" cellspacing="0" class="normal" style="vertical-align: middle">
                                    ...
                                    <tr>
                                        <td>[[CssClass]]:</td>
                                        <td>
                                            <input id="inc_class" type="text" size="14" style="width: 80px" name="inc_class" /></td>
                                    </tr>
                                    <tr>
                                        <td>[[ID]]:</td>
                                        <td>
                                            <input id="inp_id" type="text" size="14" style="width: 80px" name="inp_id" /></td>
                                    </tr>
                                    <tr>
                                        <td>[[TabIndex]]:</td>
                                        <td>
                            ...
                            <div style="padding: 3px;">
                                <table id="Table8" cellspacing="0" cellpadding="1" border="0" class="normal">
                                    ...
                                    <tr>
                                        ...
                                        <td valign="middle">
                                            <input id="inp_title" type="text" size="40" name="inp_title" /></td>
                                    </tr>
                                </table>
                            </div>
                        </fieldset>
