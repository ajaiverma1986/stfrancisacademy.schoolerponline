...
<head runat="server" id="Head1">
    ...
    <script type="text/javascript">
        var OxO7971 = []; function PostBackAction() {<%=Page.ClientScript.GetPostBackEventReference(hiddenAction,"")%>; };
    </script>
    <style type="text/css">
        #browse_Frame {
                                ...
                                <table border="0" cellpadding="2" cellspacing="0" class="normal">
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: left;">
                                            ...
                                            <img alt="" src="../Load.ashx?type=image&file=colorpicker.gif" id="bordercolor_Preview" class="cursor" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                    ...
                    <td style="vertical-align: top">
                            ...
                            <div style="padding: 3px;">
                                <table border="0" cellpadding="1" cellspacing="0" class="normal">
                                    ...
                                    <tr>
                                        ...
                                        <td valign="middle">
                                            <input type="text" id="AlternateText" size="22" name="AlternateText" /></td>
                                        <td style="white-space: nowrap">&nbsp;[[ID]]:</td>
                                        <td>
                                            <input type="text" id="inp_id" size="12" /></td>
                                        <td></td>
                                    </tr>
                                    <tr>
                                        <td style="white-space: nowrap">[[longDesc]]:</td>
                                        <td colspan="3">
                                            <input type="text" id="longDesc" size="43" name="longDesc" /></td>
                                        <td>
                                            <img alt="" src="../Load.ashx?type=image&file=Accessibility.gif" /></td>
                                    </tr>
                                </table>
                            </div>
                        </fieldset>
                        <fieldset id="fieldsetUpload">
                            ...
                            <table cellpadding="0" cellspacing="2">
                                ...
                                <tr>
                                    <td>
                                        <img class="image-align" alt="" src="../Load.ashx?type=image&file=bullet.gif" /></td>
                                ...
                                <tr>
                                    <td>
                                        <img class="image-align" alt="" src="../Load.ashx?type=image&file=bullet.gif" /></td>
                                    <td>[[AutomaticImageResizeOnOff]]
										<%= secset.AutoResizeUploadedImages? "[[on]]":"[[off]]" %>.</td>
                                </tr>
                                <%}%>
                                <tr>
                                    <td>
