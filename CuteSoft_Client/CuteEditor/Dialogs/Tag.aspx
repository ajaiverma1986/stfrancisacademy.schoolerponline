...
rel=stylesheet type=text/css href="Load.ashx?type=style&amp;file=IE.css"><![endif]-->
    ...
    <script type="text/javascript">
        var OxOd619 = ["nocancel"]; top[OxOd619[0]] = true;
    </script>
    <%}
      else
      {%>
    <script type="text/javascript">
        var OxO5789 = ["nocancel"]; top[OxO5789[0]] = false;
    </script>
    <%}%>
                    ...
                    if (tabcontrol != null)
                    {
                        ...
                        catch
                        {
                            if (Context.Request.QueryString["_err"] == "2")
                                throw;
                %>
                <iframe style="WIDTH: 378px; HEIGHT: 333px" src='<%=Context.Request.RawUrl+"&amp;_err=2"%>'></iframe>
                <%
                    }
                }
                %>
