...
<fieldset style="padding: 4px;">
    <legend>[[Backgroundimage]]</legend>
    <div style="padding: 3px;">
        [[Url]]:
        <input id="tb_image" type="text" style="width: 220px" />
    ...
    <div style="padding-left: 32px;">
        <table border="0" cellpadding="2" cellspacing="0" class="normal">
            <tr>
                ...
                <td>
                    <select id="sel_bgrepeat" style="width: 140px">
            ...
            <tr>
                <td>[[Scrolling]]: </td>
                <td>
                    <select id="sel_bgattach" style="width: 140px">
                        <option value="">[[NotSet]]</option>
    ...
    <fieldset style="padding: 4px;">
        ...
        <table border="0" cellpadding="2" cellspacing="0" class="normal">
            <tr>
                <td>[[Horizontal]]</td>
                <td>
                    <select style="width: 64" id="sel_hor">
                        <option value="">[[NotSet]]</option>
                    ...
                    [[OR]]
                    <input type="text" id="tb_hor" style="width: 60px" />
            ...
            <tr>
                <td>[[Vertical]]</td>
                <td>
                    <select style="width: 64" id="sel_ver">
                        <option value="">[[NotSet]]</option>
                    ...
                    [[OR]]
                    <input type="text" id="tb_ver" style="width: 60px" />
