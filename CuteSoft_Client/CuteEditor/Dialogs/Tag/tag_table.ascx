...
<fieldset>
    ...
    <table class="normal" width="98%">
        <tr>
            <td>[[CellSpacing]]:</td>
            <td>
                <input type="text" id="inp_cellspacing" size="14" onkeypress="return CancelEventIfNotDigit()" /></td>
            <td>[[CellPadding]]:</td>
            <td>
                <input type="text" id="inp_cellpadding" size="14" onkeypress="return CancelEventIfNotDigit()" /></td>
        </tr>
        <tr>
            <td>[[ID]]:</td>
            <td>
            ...
            <td>[[Border]]:</td>
            <td>
                <input type="text" id="inp_border" size="14" onkeypress="return CancelEventIfNotDigit()" /></td>
        </tr>
        <tr>
            <td>[[Backgroundcolor]]:
            </td>
            <td>
                <input autocomplete="off" type="text" id="inp_bgcolor" size="14" style='vertical-align: top;'
                    oncolorchange="this.value=this.selectedColor; this.style.backgroundColor=this.selectedColor" />
            </td>
            <td>[[BorderColor]]:
            </td>
            <td>
                <input autocomplete="off" type="text" id="inp_bordercolor" size="14" style='vertical-align: top;'
                    oncolorchange="this.value=this.selectedColor; this.style.backgroundColor=this.selectedColor" />
            </td>
        </tr>
        <tr>
    ...
    <table class="normal" id="CaptionTable">
        <tr>
            ...
            <td>
                <img src="Load.ashx?type=image&file=Accessibility.gif" title="Accessibility" /></td>
        </tr>
    </table>
</fieldset>
<fieldset style="margin-top: 15px">
    ...
    <table class="normal" width="98%">
        <tr>
            ...
            <td>
                <input type="text" id="inp_class" style="width: 80px" /></td>
            <td>[[Width]]:</td>
