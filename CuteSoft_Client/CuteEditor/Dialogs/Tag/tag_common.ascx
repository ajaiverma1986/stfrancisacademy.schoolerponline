    ...
    <div align="left">
        <table class="normal" width="98%">
            <tr>
                <td>[[CssClass]]:</td>
                <td>
                    <input type="text" id="inp_class" style="width: 130px" /></td>
            </tr>
            <tr>
                <td>[[Width]] :</td>
                <td>
                    <input type="text" id="inp_width" style="width: 130px" onkeypress="return CancelEventIfNotDigit()" /></td>
            </tr>
            <tr>
                <td>[[Height]] :</td>
                <td>
                    <input type="text" id="inp_height" style="width: 130px" onkeypress="return CancelEventIfNotDigit()" /></td>
            </tr>
            <tr>
                <td>[[Alignment]]:</td>
                <td>
                    <select id="sel_align" style="width: 130px">
            ...
            <tr>
                <td>[[Text-Align]]:</td>
                <td>
                    <select id="sel_textalign" style="width: 130px">
                        <option value="">[[NotSet]]</option>
                        <option value="left">[[Left]]</option>
                        <option value="center">[[Center]]</option>
                        <option value="right">[[Right]]</option>
            ...
            <tr>
                <td>[[Float]]:</td>
                <td>
                    <select id="sel_float" style="width: 130px">
                        <option value="">[[NotSet]]</option>
                        <option value="left">[[Left]]</option>
                        <option value="right">[[Right]]</option>
                    </select>
