                    ...
                    <td>
                        <table cellpadding="2" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" id="inp_MarginLeft" size="1" onkeypress="return CancelEventIfNotDigit()" /></td>
                                <td>px</td>
                                <td>&nbsp;&nbsp;</td>
                                <td align="right"><span>[[Right]]</span>:</td>
                                <td>
                                    <input type="text" id="inp_MarginRight" size="1" onkeypress="return CancelEventIfNotDigit()" /></td>
                                <td>px</td>
                            </tr>
                            <tr>
                                <td><span>[[Top]]</span>:</td>
                                <td>
                                    <input type="text" id="inp_MarginTop" size="1" onkeypress="return CancelEventIfNotDigit()" /></td>
                                <td>px</td>
                                <td>&nbsp;&nbsp;</td>
                                <td align="right"><span>[[Bottom]]</span>:</td>
                                <td>
                                    <input type="text" id="inp_MarginBottom" size="1" onkeypress="return CancelEventIfNotDigit()" /></td>
                                <td>px</td>
                            </tr>
                        </table>
                    </td>
                    ...
                    <td style="padding-bottom: 5px">
                        <table cellpadding="2" cellspacing="0">
                            ...
                            <tr>
                                <td><span>[[Left]]</span>:</td>
                                <td>
                                    <input type="text" id="inp_PaddingLeft" size="1" onkeypress="return CancelEventIfNotDigit()" /></td>
                                <td>px</td>
                                <td>&nbsp;&nbsp;</td>
                                <td align="right"><span>[[Right]]</span>:</td>
                                <td>
                                    <input type="text" id="inp_PaddingRight" size="1" onkeypress="return CancelEventIfNotDigit()" /></td>
                                <td>px</td>
                            </tr>
                            <tr>
                                <td><span>[[Top]]</span>:</td>
                                <td>
                                    <input type="text" id="inp_PaddingTop" size="1" onkeypress="return CancelEventIfNotDigit()" /></td>
                                <td>px</td>
                                <td>&nbsp;&nbsp;</td>
                                <td align="right"><span>[[Bottom]]</span>:</td>
                                <td>
                                    <input type="text" id="inp_PaddingBottom" size="1" onkeypress="return CancelEventIfNotDigit()" /></td>
                                <td>px</td>
                            </tr>
                        </table>
                    </td>
                        ...
                        <fieldset>
                            ...
                            <table class="normal" width="98%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" id="inp_id" size="16" /></td>
                                    <td></td>
                                    <td style='width: 60px'>[[CssClass]]:</td>
                                    <td>
                                        <input type="text" id="inp_class" size="16" /></td>
                                </tr>
                                <tr>
                                    <td>[[Alignment]]:</td>
                                    <td colspan="4">
