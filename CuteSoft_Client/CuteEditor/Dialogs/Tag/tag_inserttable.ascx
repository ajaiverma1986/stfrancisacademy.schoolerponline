...
<div id="list_Templates" style="display: none;">
    <div style="position: absolute; top: 0; left: 0; overflow: scroll; overflow-x: hidden; width: 100%; height: 200px">
        <div onmouseover="this.style.filter='progid:DXImageTransform.Microsoft.Gradient(GradientType=0, StartColorStr=#99ccff, EndColorStr=#FFFFFF)';"
            ...
            <span onclick="parent.selectTemplate(1)">
                <img style="vertical-align: middle" src="Load.ashx?type=image&file=One-Column-Table.gif" title="[[1ColumnTable]]" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				[[1ColumnTable]]</span>
        </div>
        <div onmouseover="this.style.filter='progid:DXImageTransform.Microsoft.Gradient(GradientType=0, StartColorStr=yellowgreen, EndColorStr=#FFFFFF)';"
            ...
            <span onclick="parent.selectTemplate(2)">
                <img style="vertical-align: middle" src="Load.ashx?type=image&file=Two-Column-Table.gif" title="[[2ColumnTable]]" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				[[2ColumnTable]]</span>
        </div>
        <div onmouseover="this.style.filter='progid:DXImageTransform.Microsoft.Gradient(GradientType=0, StartColorStr=gold, EndColorStr=#FFFFFF)';"
            onmouseout="this.style.filter='';" style="font: normal 11px Tahoma; height: 25px; background: #ffffff; border: 1px solid black; padding: 3px; padding-left: 20px; cursor: hand; border-top: 0px solid black">
            <span onclick="parent.selectTemplate(3)">
                <img style="vertical-align: middle" src="Load.ashx?type=image&file=Three-Column-Table.gif" title="[[3ColumnTable]]" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; [[3ColumnTable]]</span>
        </div>
        <div onmouseover="this.style.filter='progid:DXImageTransform.Microsoft.Gradient(GradientType=0, StartColorStr=violet, EndColorStr=#FFFFFF)';"
            onmouseout="this.style.filter='';" style="font: normal 11px Tahoma; height: 25px; background: #ffffff; border: 1px solid black; padding: 3px; padding-left: 20px; cursor: hand; border-top: 0px solid black">
            <span onclick="parent.selectTemplate(4)">
                <img style="vertical-align: middle" src="Load.ashx?type=image&file=h-R-t-Body.gif" title="[[Header-Right-TopLeft-Body]]" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; [[Header-Right-TopLeft-Body]]</span>
        </div>
        <div onmouseover="this.style.filter='progid:DXImageTransform.Microsoft.Gradient(GradientType=0, StartColorStr=#99ccff, EndColorStr=#FFFFFF)';"
            onmouseout="this.style.filter='';" style="font: normal 11px Tahoma; height: 25px; background: #ffffff; border: 1px solid black; padding: 3px; padding-left: 20px; cursor: hand; border-top: 0px solid black">
            <span onclick="parent.selectTemplate(5)">
                <img style="vertical-align: middle" src="Load.ashx?type=image&file=h-l-tr-Body.gif" title="[[Header-Left-TopRight-Body]]" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; [[Header-Left-TopRight-Body]]</span>
        </div>
        <div onmouseover="this.style.filter='progid:DXImageTransform.Microsoft.Gradient(GradientType=0, StartColorStr=#99ccff, EndColorStr=#FFFFFF)';"
            onmouseout="this.style.filter='';" style="font: normal 11px Tahoma; height: 25px; background: #ffffff; border: 1px solid black; padding: 3px; padding-left: 20px; cursor: hand; border-top: 0px solid black;">
            <span onclick="parent.selectTemplate(6)">
                <img style="vertical-align: middle" src="Load.ashx?type=image&file=h-f-3Columns-Body.gif" title="[[Header-Footer-3-Columns]]" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; [[Header-Footer-3-Columns]]</span>
        </div>
    </div>
</div>
<style type="text/css">
...
<div style="padding: 4px 5px 0 4px; width: 99%">
    <table border="0" cellspacing="0" cellpadding="2" class="normal" width="99%">
        <tr>
            <td align="center">[[EditCell]]
            </td>
            <td align="center">[[Columns]]:
                <button id="subcolumns" class="addsub">-</button>
                <button id="addcolumns" class="addsub">
                    +</button>
                ColSpan :
                <button id="subcolspan" class="addsub">-</button>
                <button id="addcolspan" class="addsub">
                    +</button>
            </td>
            <td></td>
        </tr>
            ...
            <td>
                <table class="normal" cellspacing="3">
                    ...
                    <tr>
                        <td>[[Width]]</td>
                        <td>
                            <input type="text" id="inp_cell_width" style="width: 60px" /></td>
                    </tr>
                    <tr>
                        <td>[[Height]]:</td>
                        <td>
                            <input type="text" id="inp_cell_height" style="width: 60px" /></td>
                    </tr>
