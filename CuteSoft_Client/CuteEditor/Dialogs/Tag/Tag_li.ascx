...
<table width="85%" align="center" cellpadding="1" cellspacing="2" id="tag-list">
        ...
        <td class="box">
            <div id="box1" style="color: #555555; border: solid 2px #ffffff; padding: 0px;"
                ...
                <ul style="list-style-type: none;">
                    <li>
                        <div>
                            <img src="../images/listbar.gif"></div>
                        <div>
                            <img src="../images/listbar.gif"></div>
                    </li>
                    <li>
    ...
    <tr>
        <td colspan="5" style="padding-top: 5; height: 4"></td>
    </tr>
    <tr>
        <td class="box">
    ...
    <tr>
        <td nowrap colspan="5" style="padding-top: 5">
            <span style="width: 90">[[StartingNumber]]</span>:
            <input onkeypress="return CancelEventIfNotDigit()" id="inp_start" type="text" name="inp_start" value="1" size="3">
        </td>
    </tr>
    <tr>
        <td colspan="5">
