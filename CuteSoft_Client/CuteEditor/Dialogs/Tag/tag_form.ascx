...
<fieldset>
    ...
    <table class="normal" width="98%">
        <tr>
            ...
            <td>
                <input type="text" id="inp_action" style="width: 300px" /></td>
        </tr>
        <tr>
            <td>[[Method]]:</td>
            <td>
        ...
        <tr>
            <td>[[Name]]:</td>
            <td>
                <input type="text" id="inp_name" style="width: 200px" /></td>
        </tr>
        <tr>
            <td>[[ID]]:</td>
            <td>
                <input type="text" id="inp_id" style="width: 200px" /></td>
        </tr>
        <tr>
            <td>[[EncodingType]]:</td>
            <td>
                <input type="text" id="inp_encode" style="width: 200px" /></td>
        </tr>
        <tr>
            <td>[[Target]]:</td>
            <td>
