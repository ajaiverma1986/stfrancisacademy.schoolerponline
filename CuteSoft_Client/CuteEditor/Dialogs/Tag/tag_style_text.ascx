...
<fieldset>
    ...
    <table border="0" cellpadding="2" cellspacing="0" class="normal">
        <tr>
            <td>[[Letters]]</td>
            <td>
                <select style="width: 80px" id="sel_letter">
                    <option value="">[[NotSet]]</option>
                    <option value="normal">[[Normal]]</option>
                </select>
                [[OR]]
                <input type="text" id="tb_letter" style="width: 60px" />
        ...
        <tr>
            <td>[[Height]]</td>
            <td>
                <select style="width: 80px" id="sel_line">
                    <option value="">[[NotSet]]</option>
                    <option value="normal">[[Normal]]</option>
                </select>
                [[OR]]
                <input type="text" id="tb_line" style="width: 60px" />
...
<fieldset>
    <legend>[[TextFlow]]</legend>
    <table border="0" cellspacing="0" cellpadding="2" class="normal">
        <tr>
            <td style="width: 80px">[[Indentation]]:
            </td>
            <td>
                <input type="text" id="tb_indent" style="width: 42" />
