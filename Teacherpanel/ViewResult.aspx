<%@ Page Title="" Language="C#" MasterPageFile="~/Teacherpanel/employee-panel-master.master" AutoEventWireup="true" CodeFile="ViewResult.aspx.cs" Inherits="Teacherpanel_ViewResult" %>
     ...
     <div class="col-md-9">
        ...
        <div id="divall" runat="server">
            ...
            <div class="for_sigle_row_form" runat="server" id="two">
                ...
                <asp:DropDownList ID="ddlSection" runat="server" Width="26%"  CssClass="btn btn-secondry dropdown-toggle" OnSelectedIndexChanged="ddlSection_SelectedIndexChanged1" AutoPostBack="true" >
                </asp:DropDownList>
            </div>
            <div class="for_sigle_row_form" runat="server" id="Div1">
                ...
                <asp:DropDownList ID="ddlResultType" Enabled="false" Width="26%"  CssClass="btn btn-secondry dropdown-toggle" runat="server" OnSelectedIndexChanged="ddlSection_SelectedIndexChanged" AutoPostBack="true" >
                    ...
                    <asp:ListItem Value="5" Text="Term I-II-III"></asp:ListItem>
                </asp:DropDownList>
            </div>
