        ...
        try
        {
            ...
            if (validate(IsGradeType))
            {
                foreach (GridViewRow row in grdsetmarks.Rows)
                {
                    ...
                    var result = uploadMarksNew(lblregno.Text, ddlsubject.SelectedValue, ddlexam.SelectedValue, marks.ToString(), IsGradeType, IsAbsent);
