<%@ Page Title="" Language="C#" MasterPageFile="~/Teacherpanel/employee-panel-master.master" AutoEventWireup="true" CodeFile="ExamUtility.aspx.cs" Inherits="Teacherpanel_ExamUtility" %>
...
<div style="margin-left:21px">
  <!--  <asp:Button ID="Button5" runat="server" Text="Set Co - Scholastic Areas" OnClick="Button5_Click"
    ...
    <asp:Button ID="btnsetmarks" runat="server" Text="Set Marks and Grade" OnClick="btnsetmarks_Click"
