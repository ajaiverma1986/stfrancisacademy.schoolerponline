<%@ Page Title="" Language="C#" MasterPageFile="~/Teacherpanel/employee-panel-master.master" AutoEventWireup="true" CodeFile="StuAssignment.aspx.cs" Inherits="Teacherpanel_StuAssignment" %>
        ...
        <div class="content_pane_cont input_content" id="contentPane">
             ...
             <div class="main-div-tbl">
                <div class="new-registration">
                    ...
                    <div class="for_sigle_row_form">
                        ...
                        <asp:DropDownList ID="ddlapplyingforclass" Width="26%"  CssClass="btn btn-secondry dropdown-toggle" runat="server" onselectedindexchanged="ddlapplyingforclass_SelectedIndexChanged" AutoPostBack="true">
                    ...
                    <div class="for_sigle_row_form">
                        ...
                        <asp:TextBox ID="txtdateforattendance" Width="15%"  runat="server" placeholder="Select Date Please" CssClass="form-control"></asp:TextBox>
                    </div>
                     <div class="clear"></div>
            <div class="for_sigle_row_form">
                <label>
                ...
                <asp:TextBox ID="txttopic" runat="server" Width="15%" CssClass="form-control" ></asp:TextBox>
            </div>
                    <div class="for_sigle_row_form">
                <label>
                    Assign By<span style="color: Red">*</span>
                </label> 
                <asp:TextBox ID="txtassign" runat="server" Width="15%" CssClass="form-control"></asp:TextBox>
            </div>
            ...
            <asp:Button ID="btnSend" runat="server" Text="Upload " CssClass="button_save" 
                ToolTip="Click here to upload the assignment." OnClick="btnSend_Click" />
                    ...
                    <div class="ClassForAttendance">
                        <asp:GridView ID="GrdAttendence" Visible="false" AutoGenerateColumns="false" Width="100%" BorderWidth="0"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Section Name">
                 ...
                 <asp:TemplateField HeaderText="Assign Topic">
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="Upload File">
                    <ItemTemplate>
                        <asp:HiddenField ID="HD2" runat="server" Value='<%# Bind("document") %>' />
                       <%-- <asp:Label ID="lbltopic"  runat="server" Text='<%# Bind("document") %>' Style="display:none"></asp:Label>--%>
                        <asp:Image ID="lbimage" runat="server" ImageUrl="~/images/edit.png" CssClass="detailimage"/>
                    </ItemTemplate>
                    <ItemStyle Width="12%" />
                </asp:TemplateField>
            </Columns>
