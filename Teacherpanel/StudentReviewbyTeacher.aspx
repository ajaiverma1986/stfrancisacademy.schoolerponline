<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/Teacherpanel/employee-panel-master.master" CodeFile="StudentReviewbyTeacher.aspx.cs" Inherits="Teacherpanel_StudentReviewbyTeacher" %>
            ...
            <div class="main-div-tbl">
                <div class="new-registration">
                    ...
                    <div class="for_sigle_row_form">
                        ...
                        <asp:DropDownList ID="ddlapplyingforclass"  Width="34%"  CssClass="btn btn-secondry dropdown-toggle" runat="server" OnSelectedIndexChanged="ddlapplyingforclass_SelectedIndexChanged">
                    ...
                    <div class="for_sigle_row_form">
                        ...
                        <asp:DropDownList ID="ddlsection" Width="34%"  CssClass="btn btn-secondry dropdown-toggle" runat="server">
                    ...
                    <div class="for_sigle_row_form">
                        ...
                        <asp:TextBox ID="txtdateforattendance" CssClass="" Width="23px" runat="server" placeholder="Select Date Please" onkeypress="return false"></asp:TextBox>
                    </div>
                    <div class="sub-heading">
                        Student List
                    </div>
