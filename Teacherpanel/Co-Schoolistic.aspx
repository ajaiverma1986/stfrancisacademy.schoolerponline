<%@ Page Title="" Language="C#" MasterPageFile="~/Teacherpanel/employee-panel-master.master" AutoEventWireup="true" CodeFile="Co-Schoolistic.aspx.cs" Inherits="Teacherpanel_Co_Schoolistic" %>
            ...
            <div class="content-inner">
                ...
                <div id="divforsetmarks" style="display: block" runat="server">
                    <div class="for_sigle_row_form">
                        ...
                        &nbsp;&nbsp;&nbsp;<asp:DropDownList ID="ddlexam" Width="16%" AutoPostBack="true" BackColor="#f3eee7"  class="btn btn-secondry dropdown-toggle" runat="server" OnSelectedIndexChanged="ddlexam_SelectedIndexChanged">
                    ...
                    <div class="for_sigle_row_form">
                        ...
                        <asp:DropDownList ID="ddlcourse" Enabled="false"  runat="server" Width="16%" BackColor="#f3eee7" CssClass="btn btn-secondry dropdown-toggle" AutoPostBack="true" OnSelectedIndexChanged="ddlcourse_SelectedIndexChanged">
                    ...
                    <div class="for_sigle_row_form">
                        ...
                        <asp:DropDownList ID="ddlsection" runat="server" Width="16%" AutoPostBack="true" BackColor="#f3eee7" class="btn btn-secondry dropdown-toggle"  OnSelectedIndexChanged="ddlsection_SelectedIndexChanged" Enabled="false">
