<%@ Page Title="" Language="C#" MasterPageFile="~/Teacherpanel/employee-panel-master.master" AutoEventWireup="true" CodeFile="employee-panel-home-page.aspx.cs" Inherits="EmployeePanel_employee_panel_home_page" %>
        ...
        <div class="content-wrapper">
            <div class="content-inner">
                ...
                <div class="main-content">
                    ...
                    <div class="widget">
                        <div class="row">
                            <div style="margin-left: 29px;"  class="col-lg-3 col-md-4 col-sm-6 text-center">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 text-center" style="margin-left: 30px;">
                                <div class="widget-content-blue-wrapper changed-up" style="width: 240px!important; height: 173px!important">
                                    <div class="widget-content-blue-inner padded" style="height: 142px!important">
                                        <div class="pre-value-block">
                                            <i class="icon-tag"></i>
                                            <asp:LinkButton ID="lnkprofile" runat="server" Text="Your Profile" PostBackUrl="employee-view-profile.aspx"></asp:LinkButton>
                                        </div>
                                        <div class="value-block">
