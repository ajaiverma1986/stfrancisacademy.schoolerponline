...
public partial class Teacherpanel_StudentReviewbyTeacher : System.Web.UI.Page
{
    ...
    public static BindAttendance[] BindAttendanceGrid(string Classid, string SectionId, string Date)
    {
        ...
        Param[2] = new SqlParameter("@Date", DateTime.ParseExact(Date, "dd MMMM yyyy",null));
        Param[3] = new SqlParameter("@Brid", HttpContext.Current.Session["BrBrid"]);
        Param[4] = new SqlParameter("@callType", "Sel");
        DataTable Dt = ObjDut.GetDataTableSP(Param, "[usp_StudentReview]");
        for (int i = 0; i < Dt.Rows.Count; i++)
        {
    ...
    public static int TakeAttendance(string AdmissionNo, string SturegNo, string AttendanceStatus, string Date)
    {
        ...
        Param[2] = new SqlParameter("@Review", AttendanceStatus);
       
        Param[3] = new SqlParameter("@Date", DateTime.ParseExact(Date, "dd MMMM yyyy", null));
        Param[4] = new SqlParameter("@Brid", Convert.ToInt32(HttpContext.Current.Session["BrBrid"]));
        ...
        Param[6] = new SqlParameter("@SystemName", "");
        Param[7] = new SqlParameter("@callType", "save");
        Param[8] = new SqlParameter("@intresult", SqlDbType.Int);
        Param[8].Direction = ParameterDirection.Output;
        intresult = Objdut.ExecuteSqlSP(Param, "[usp_StudentReview]");
