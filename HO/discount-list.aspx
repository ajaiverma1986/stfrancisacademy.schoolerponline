<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="discount-list.aspx.cs" Inherits="BranchPanel_DiscountManagement_discount_list" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="content_pane_cont input_content" id="contentPane">
        ...
        <div class="searchbar containerHeadline">
            ...
            <asp:TextBox ID="txttodate" runat="server" onkeypress="return false" placeholder="To Date" Width="60px"></asp:TextBox>
             <asp:TextBox ID="txtdiscountcode" onkeypress="return isNumberKey(event)" MaxLength="10" runat="server" placeholder="Discount Code" Width="90px"></asp:TextBox>
             <asp:TextBox ID="txtregnumber" runat="server" placeholder="Registration No" Width="99px" Height="25px"></asp:TextBox>
            <asp:TextBox ID="txtstuname" onkeypress="return lettersOnly(event)" MaxLength="15" runat="server" placeholder="Student Name" Width="90px"></asp:TextBox>          
            <asp:TextBox ID="txtfathername" onkeypress="return lettersOnly(event)" MaxLength="15" runat="server" placeholder="Parent Name" Width="80px"></asp:TextBox>
            ...
            <div class="clear"></div>
             <asp:DropDownList ID="ddlbranch" runat="server" style="height: 31px; width: 130px;margin-left:0px"></asp:DropDownList>  
    ...
    <script type="text/javascript">
        var pagesize = 100, pageno = 1,BrId=0, Fromdate = '', admissionno = '', Todate = '', TotalActualAmount = 0, TotalDiscountAmount = 0, TotalFeeAfterDiscount = 0, Discountcode = '', Registrationnumber = '', StudentName = '', Applyingforclass = 0, Parentname = '', checkNo = '',BrId=1, studentid = 0, paymentmode = 0, Fyid = 1, discountcode = '', discountid = 0, ParentMobileNo = '', discountgivenbyuser = 0;
        $(document).ready(function () {
            ...
            $("#ctl00_ContentPlaceHolder1_ddlclass,#ctl00_ContentPlaceHolder1_ddlbranch,#ctl00_ContentPlaceHolder1_ddlfyear,#ctl00_ContentPlaceHolder1_ddldiscountgivenbyuser").on('change keyup paste', function () {
                FillField();
                Bindstudentdiscount();
                return false;
            });            
        ...
        function ClearAll() {
            ...
            Applyingforclass = 0,BrId=1, Status = 0, Fyid = 1;
            ...
            $('#ctl00_ContentPlaceHolder1_ddlbranch,#ctl00_ContentPlaceHolder1_ddlfyear,#ctl00_ContentPlaceHolder1_ddldiscountgivenbyuser').val('0');
            Bindclassddl();
        }
        ...
        function Bindclassddl() {
            ...
            $.ajax({
                type: 'POST',
                contentType: "application/json; charset=utf-8",
                url: "discount-list.aspx/BindClassDDL",
