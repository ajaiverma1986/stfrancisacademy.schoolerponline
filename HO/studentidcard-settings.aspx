<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="studentidcard-settings.aspx.cs" Inherits="HO_studentidcard_settings" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <div class="">
            ...
            <div class="searchbar containerHeadline for_sigle_row_form">
                ...
                <select style="height: 31px; width: 60px;" runat="server" id="ddlpazesize">
                 ...
                 <select style="height: 31px; width: 140px;" runat="server" id="ddlbranch"></select>
            ...
            <div id="divvertical">
                <table class="Binddivvertical" style="margin: 0 7px; width:100%">
                </table>
            </div>
            <div class="clear"></div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#btnclear").click(function () {
                classid = 0, AdmissionNo = '', Mobileno = '', Name = '',Brid=0;
        ...
        function Savesetting() {
            ...
            $.ajax({
                ...
                url: "studentidcard-settings.aspx/Addidcartsetting",
        ...
        function Fillsetting() {
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "studentidcard-settings.aspx/Fillsetting",
                data: "{}",
                dataType: "json",
                async: false,
                success: function (data) {
    ...
    function Binddivhorizontal() {
        ...
        $.ajax({
            type: "POST",
            contentType: "application/json; charset=utf-8",
            url: "studentidcard-settings.aspx/BindGridByJs",
            ...
            success: function (data) {
                ...
                if (data.d.length > 0) {
                    ...
                    for (var i = 0; i < data.d.length; i++) {
                       ...
                       '<b style="font-family: Arial; color: #010060; font-weight: bold; padding-left:8px;">Admission No: </b> <span>' + data.d[i].AdmissionNo + '</span><br />' +
            ...
            success: function (data) {
                ...
                if (data.d.length > 0) {
                    ...
                    for (var i = 0; i < data.d.length; i++) {
                       ...
                       ' <b style="font-family: Arial; color: #010060; font-size:13px; padding-left:8px;">Admission No: </b><span style="font-family: Arial; color: #010060; font-size:13px;">' + data.d[i].AdmissionNo + '</span><br />' +
            ...
            success: function (data) {
                ...
                if (data.d.length > 0) {
                    ...
                    for (var i = 0; i < data.d.length; i++) {
                       ...
                       '<b>Admission No: <span>' + data.d[i].AdmissionNo + '</span></b><div style="display: none"><input type="hidden" value=' + data.d[i].Registration_No + ' /></div><br />' +
    ...
    function View_Type() {
        $.ajax({
            type: "POST",
            contentType: "application/json; charset=utf-8",
            url: "studentidcard-settings.aspx/Viewtype",
            data: "{}",
            dataType: "json",
            async: false,
            success: function (data) {
