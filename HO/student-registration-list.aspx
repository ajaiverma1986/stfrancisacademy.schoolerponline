<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="student-registration-list.aspx.cs" Inherits="HO_Student_Registration_student_registration_list" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="content_pane_cont input_content" id="contentPane">
        ...
        <div class="searchbar containerHeadline">
            ...
            <div class="clear"></div>
             <asp:DropDownList ID="ddlbranch" runat="server" style="height: 31px; width: 260px;margin-left:0px"></asp:DropDownList>
     ...
     <script type="text/javascript">
         var Admissionnnumber = '',BrId=1, admissionstatus = '',pagesize = 100, pageno = 1, mode = 1, IsAdmissionTaken = 0, Fromdate = '', Todate = '', Registrationnumber = '', StudentName = '', Applyingforclass = 0, Status = 0, Parentname = '', ParentMobileNo = '', RID = 0, Fyid = $('#ctl00_ContentPlaceHolder1_ddlfyear').val();
         $(document).ready(function () {
             ...
             $("#ctl00_ContentPlaceHolder1_ddlclass,#ctl00_ContentPlaceHolder1_ddlbranch,#ctl00_ContentPlaceHolder1_ddlfyear,#ctl00_ContentPlaceHolder1_ddlstatus").on('change keyup paste', function () {
                 FillField();
                 Bindstudentregistration();
                 return false;
             });
         ...
         function ClearAll() {
             ...
             Applyingforclass = 0, Status = 0, Fyid = 1, BrId=1;
             ...
             $('#ctl00_ContentPlaceHolder1_ddlbranch,#ctl00_ContentPlaceHolder1_ddlfyear').val('1');
