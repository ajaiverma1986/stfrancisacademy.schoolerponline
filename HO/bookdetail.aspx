<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="bookdetail.aspx.cs" Inherits="HO_bookdetail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <div id="booklist" class="for_sigle_row_form">
           ...
           <asp:TextBox ID="Txtbookid" runat="server" style="height:23px;width:90px;" placeholder="Enter Book Id"></asp:TextBox>
                ...
                <asp:DropDownList ID="ddlbranch" runat="server" style="width:100px;height:31px"></asp:DropDownList>
     ...
     <script type="text/javascript">
         //*********************************************************variable***********************************************
         var bookid = "", isbn = "", title = "", category = 0, publisher = "0", author = "0", fyid = 0, subcategory = 0, keywords = "", hiddenbookid = "",brid=0;
         //********************************************************progressbar*****************************************
    ...
    <script type="text/javascript">
        ...
        $("#btnclearalld").click(function () {
            ...
            bookid = "", isbn = "", title = "", category = 0, publisher = "0", author = "0", fyid = 0, subcategory = 0, keywords = "", brid = 0;
            Bindbooklist();
            return false;
        });
        //**********************************************booklist******************************************************************
        function Bindbooklist() {
            ...
            $.ajax({
                ...
                data: "{'bookid':'" + bookid.split("'").join("~") + "','isbn':'" + isbn.split("'").join("~") + "','title':'" + title.split("'").join("~") + "','category':'" + category + "','publisher':'" + publisher + "','author':'" + author + "','fyid':'" + fyid + "','subcategory':'" + subcategory + "','keywords':'" + keywords.split("'").join("~") + "','brid':'"+brid+"'}",
                dataType: "json",
                async: false,
