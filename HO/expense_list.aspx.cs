...
public partial class HO_expense_list : System.Web.UI.Page
{
    ...
    {
        string Query = "select titleid,titlename from tbl_expencemaster where status=1 and titlename<>'salary'";
