...
public partial class HO_addclasswithbranch : System.Web.UI.Page
{
    private string url;
    ...
    {
        string str = "select BrId, BrName,BrCode  from Branch_master where BrActive=1 and isActive=1 ";
    ...
    protected void grdBranch_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "c1")
        {
            ...
            param[1] = new SqlParameter("@brid", ViewState["brid"]);
    ...
    protected void btnSubmit_Click1(object sender, EventArgs e)
    {
        ...
        param[0] = new System.Data.SqlClient.SqlParameter("@brid", Convert.ToInt32(ViewState["brid"]));
        ...
        int intresult = objdut.ExecuteSqlSP(param, "addclasssinbranch");
