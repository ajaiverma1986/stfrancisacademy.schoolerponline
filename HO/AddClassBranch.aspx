<%@ Page Title="Add Class With Branch" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AddClassBranch.aspx.cs" Inherits="HO_addclasswithbranch" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="content_pane_cont input_content branch-div-tbl" id="contentPane">
        <div class="tbl-top-heading" style="width: 100%; margin-left: 0px">
            <h2>List of Added Class with Branch</h2>
        </div>
                            ...
                            <asp:GridView ID="grdBranch" AutoGenerateColumns="false" Width="100%" BorderWidth="0"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Branch Code">
                                        <ItemTemplate>
                                            <asp:Label ID="lblSNo3" Text='<%#Eval("BrCode") %>' runat="server"></asp:Label>
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Center" />
                                    ...
                                    <asp:TemplateField HeaderText="Branch">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lblsubject" runat="server" Text='<%# Bind("brname") %>' CommandName="c1"
                                                CommandArgument='<%# Bind("brid") %>' ForeColor="black" Font-Underline="true"
                                    ...
                                    <asp:TemplateField HeaderText="Edit" Visible="false">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lblsubject22" Font-Underline="true" ToolTip="Click here to update Class for this Branch."
                                                runat="server" Text="Edit" CommandName="c2" CommandArgument='<%# Bind("brid") %>'></asp:LinkButton>
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Center" Width="15%" />
                                    </asp:TemplateField>
