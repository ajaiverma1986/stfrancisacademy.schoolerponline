<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PaymenApiToClass.aspx.cs" Inherits="HO_PaymenApiToClass" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="content_pane_cont input_content branch-div-tbl" id="contentPane">
        <div class="tbl-top-heading" style="width: 100%; margin-left: 0px">
            <h2>List of Payment ProductID with Class</h2>
        </div>
            ...
            <table cellpadding="2" cellspacing="0" border="0" style="width: 1000px; border-left: none !important;">
                <tr>
                    <td colspan="4" style="vertical-align: top; width: 500px;">
                            ...
                            <asp:GridView ID="grdAPI" AutoGenerateColumns="false" Width="100%" BorderWidth="0"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="ProductID">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lblsubject" runat="server" Text='<%# Bind("ProductID") %>' CommandName="c1"
                                                CommandArgument='<%# Bind("SchoolID") %>' ForeColor="black" Font-Underline="true"
                                    ...
                                    <asp:TemplateField HeaderText="Edit" Visible="false">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lblsubject22" Font-Underline="true" ToolTip="Click here to update Class for this Branch."
                                                runat="server" Text="Edit" CommandName="c2" CommandArgument='<%# Bind("SchoolID") %>'></asp:LinkButton>
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Center" />
                        ...
                        <div id="divbtnSubmit" runat="server" class="for_sigle_row_form" style="width: 400px; margin-top: 5px; display:none">
