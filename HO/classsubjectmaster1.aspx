<%@ Page Title="Add Subject In Class" Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="~/HO/classsubjectmaster1.aspx.cs" Inherits="HO_classsubjectmaster1" %>
                            ...
                            <asp:GridView ID="grdsubject" AutoGenerateColumns="false" Width="100%" BorderWidth="0"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Compulsory Subject">
                                        <ItemTemplate>
                                            <asp:Label ID="lblsubject123" runat="server" Text='<%# Bind("SubjectName") %>'></asp:Label>
