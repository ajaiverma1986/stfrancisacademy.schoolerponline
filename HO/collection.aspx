<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="collection.aspx.cs" Inherits="HO_collection" %>
    ...
    <div class="branch-div-tbl">
        ...
        <div class="clear"></div>
           ...
           <div class="searchbar containerHeadline" id="GridBatch">
               ...
               <asp:TextBox ID="txtname" runat="server" Placeholder="Name" Width="100px" Height="25px"></asp:TextBox>
               <asp:TextBox ID="txtmobile" runat="server" Placeholder="Mobile No. " Width="100px" Height="25px"></asp:TextBox>
        ...
        <script type="text/javascript">
            var fromdate = "", todate = "", name = "", Total = 0, TotalFeePaid = 0, Fyid = 1, TotalServiceTax = 0, PaidTaxAmount = 0, mobileno = '', receiptno = "", pagesize = 100, pageno = 1, pagecount = 1, paymentmode = 0, brid = 0;
            $(document).ready(function () {
                ...
                $("#ctl00_ContentPlaceHolder1_txtname,#ctl00_ContentPlaceHolder1_txtmobile,#ctl00_ContentPlaceHolder1_txtreciptno").change(function () {
            ...
            function ClearField() {
                fromdate = "", todate = "", name = "", mobileno = "", receiptno = "", paymentmode = 0, Fyid = 1,brid=0;
            ...
            function BindGrid() {
                ...
                $.ajax({
                    ...
                    data: "{'fromdate':'" + fromdate + "','todate':'" + todate + "','name':'" + name + "','receiptno':'" + receiptno + "','mobileno':'" + mobileno + "','paymentmode':'" + paymentmode + "','Fyid':'" + Fyid + "','brid':'" + brid + "','pageno':'" + pageno + "'}",
                    dataType: "json",
                    success: function (data) {
                        ...
                        if (data.d.length > 0) {
                            ...
                            for (var i = 0; i < data.d.length; i++) {
                                ...
                                TotalFeePaid = parseFloat(data.d[i].TtlPaidAmountWithOutTax);

                                TotalServiceTax = parseFloat(data.d[i].TtlPaidTaxAmount);

                                Total = parseFloat(data.d[i].TtlTotal);
                            }
