<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="sms-settings.aspx.cs" Inherits="HO_sms_settings" %>
    ...
    <script type="text/javascript">
        ...
        function Save() {
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "sms-settings.aspx/updatesmsapi",
        ...
        function GetSmsApi() {
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "sms-settings.aspx/getsmsapi",
                data: "",
                dataType: "json",
                async: false,
                success: function (data) {
