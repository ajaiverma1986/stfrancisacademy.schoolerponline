...
public partial class HO_bookdetail : System.Web.UI.Page
{
    ...
    [WebMethod]
    public static booklistlist[] fillbooklist(string bookid, string isbn, string title, string category, string publisher, string author, string fyid, string subcategory, string keywords,string brid)
    {
