<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="rollback-fee-list.aspx.cs" Inherits="HO_rollback_fee_list" %>
        ...
        <div class="content_pane_cont input_content" id="contentPane">
           ...
           <div class="searchbar containerHeadline ">
               ...
               <div class="for_sigle_row_form" id="divforsearching" runat="server">
                   <asp:DropDownList ID="ddlfinacialyearforsearching" runat="server" Style="width:130px;height:31px">
                   </asp:DropDownList>
                   <asp:DropDownList ID="ddlbranch" runat="server" style="height:31px; width:130px;"></asp:DropDownList>
                                <input type="text" style="width:130px; " placeholder="Student Name" id="sname" />
                                <input type="text" style="width:130px; margin-left: 5px;" placeholder="Student Mobile" id="smob" onkeypress="if (WebForm_TextBoxKeyHandler(event) == false) return false;return noAlphabets(event)" />
                                <select style="height: 31px; width:130px; " id="dllclass"></select>
                                <input type="text" style="width:100px; " placeholder="From Date" id="txtfromdate" onkeypress="return false"/>
                                <input type="text" style="width:100px;" placeholder="To Date" id="txttodate" onkeypress="return false"/>
           ...
           <div class="divTableDataHolder m-l-sm m-r-sm">
            ...
            <script type="text/javascript">
                var name = "", stmob = "", classid = 0, frdate = "", todate = "", pagesize = 100, pageno = 1, pagecount = 1, fyid = 0, brid=0;
                $(document).ready(function () {
                    $("#dllclass").append('<option value=1>-Select Class-</option>');
                ...
                function BindGrid() {
                    ...
                    $.ajax({
                        ...
                        data: "{'name':'" + name + "','stmob':'" + stmob + "','classid':'" + classid + "','frdate':'" + frdate + "','todate':'" + todate + "','pagesize':'" + pagesize + "','pageno':'" + pageno + "','fyid':'" + fyid + "','brid':'" + brid + "'}",
                        dataType: "json",
                        async: false,
