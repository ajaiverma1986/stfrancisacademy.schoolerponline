<%@ Page Title="" Language="C#" MasterPageFile="~/BranchPanel/MasterPage.master" AutoEventWireup="true" CodeFile="DailyFeeTrans.aspx.cs" Inherits="BranchPanel_Fee_Management_DailyFeeTrans" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="branch-div-tbl">
        ...
        <ul>
            ...
            <li style="background: none;"><a class="active">Daily Fee List</a></li>
        </ul>
    ...
    <div class="content_pane_cont input_content" id="contentPane">
        ...
        <div class="conductedlecture234 secbox" style="border: 1px solid #DEB1D9;">
                <dd>Total Fee Transaction</dd>
                <div class="clear"></div>
               <span id="lblTotalDailyFee" style="font-weight: bold;"></span>
            </div>
        <div class="conductedlecture234 secbox" style="border: 1px solid #f5d88c; visibility:hidden">
                <dd>Total Fee Amount</dd>
                <div class="clear"></div>
                <span id="lblTotalFee" style="font-weight: bold;"></span>
            </div>
         
            <div class="conductedlecture234 secbox" style="border: 1px solid #f5d88c; visibility:hidden">
                <dd>Total Balance</dd>
                <div class="clear"></div>
                <span id="lblTotalBalFee" style="font-weight: bold;"></span>
            </div>
           ...
           <%-- <div class="conductedlecture234 firstbox" style="border: 1px solid #DEB1D9;">
            ...
            <div class="grid-data-resposive">
                <div class="searchbar containerHeadline ">
                    ...
                    <input type="text" id="txtPaiddatefrom" placeholder="Enter Paid Date From" readonly="readonly" style="height: 31px; width: 140px;"/>
                    <input type="text" id="txtPaiddateto" placeholder="Enter Paid Date To" readonly="readonly" style="height: 31px; width: 140px;"/>
                    ...
                    <input type="text" id="txtduedatefrom" placeholder="Enter Due Date From" readonly="readonly" style="height: 31px; visibility:hidden; width: 140px;"/>
                    <input type="text" id="txtduedateto" placeholder="Enter Due Date To" readonly="readonly" style="height: 31px; visibility:hidden; width: 140px;"/>
    ...
    <script type="text/javascript">
        var Fyid = 0, pagesize = 100, pageno = 1, pagecount = 0, stuname = '', duefromdate = '', duetodate = '', Paidfromdate = '', Paidtodate = '', mobileno = '', classid = 0, year = 2050;
        ...
        $("#txtPaiddatefrom,#txtPaiddateto").datepicker({
            changeMonth: true,
            changeYear: true,
            yearRange: '2000:' + year,
            dateFormat: 'dd MM yy'
        ...
        $("#txtname,#txtduedatefrom,#txtduedateto,#txtPaiddatefrom,#txtPaiddateto,#txtmobile,#ctl00_ContentPlaceHolder1_ddlclass").on('change keyup paste', function () {
            FillField();
            return false;
        });
        ...
        function FillField() {
            ...
            Paidfromdate = $('#txtPaiddatefrom').val();
            Paidtodate = $('#txtPaiddateto').val();
        ...
        function BindGridAfterSearch() {
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "DailyFeeTrans.aspx/BindGridOfDailyFeeList",
                data: "{'Fyid':'" + Fyid + "','pagesize':'" + pagesize + "','pageno':'" + pageno + "','stuname':'" + stuname + "','duefromdate':'" + duefromdate + "','duetodate':'" + duetodate + "','Paidfromdate':'" + Paidfromdate + "','Paidtodate':'" + Paidtodate + "','mobileno':'" + mobileno + "','classid':'" + classid + "'}",
                dataType: "json",
                async: false,
                success: function (data) {
                    if (data.d.length > 0) {
                        ...
                        $("#lblTotalFee").text(parseFloat(data.d[0].TotalOverDueFee) + parseFloat(data.d[0].TotalBalance));
                        $("#lblTotalDailyFee").text(data.d[0].TotalOverDueFee);
                        $("#lblTotalBalFee").text(data.d[0].TotalBalance);
                        if ($(".lblpage").html() == 0) {
                            $(".lblpage").html(1);
                        }
                        for (var i = 0; i < data.d.length; i++) {
                            if (i % 2 != 0)
                                trforappend = '<tr class="stm_light"><td>' + data.d[i].Rownumber + '</td>' +
                                    ...
                                    '<td><span>' + data.d[i].PaidDate + '</span></td>' +
