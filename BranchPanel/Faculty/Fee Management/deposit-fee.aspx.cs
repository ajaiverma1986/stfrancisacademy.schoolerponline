...
public partial class BranchPanel_Fee_Management_deposit_fee : System.Web.UI.Page
{
    ...
    [WebMethod]
    public static string BindFeeDetails(string pageno, string pagesize, string name, string admission, string fyid, string classid, string SectionID, string duefromdate, string duetodate)
    {
        ...
        param[7] = new SqlParameter("@Sectionid", classid);
        param[8] = new SqlParameter("@Name", name);
