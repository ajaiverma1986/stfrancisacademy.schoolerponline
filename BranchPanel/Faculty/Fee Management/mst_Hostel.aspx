<%@ Page Title="" Language="C#" MasterPageFile="~/BranchPanel/MasterPage.master" AutoEventWireup="true" CodeFile="mst_Hostel.aspx.cs" Inherits="BranchPanel_Fee_Management_mst_Hostel" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="content_pane_cont input_content branch-div-tbl" id="FIELDSET1" runat="server">
         <div class="tbl-top-heading" style="width: 100%; margin-left: 0px">
            <h2>Fee Fine</h2>
             <asp:Button runat="server" ID="Button2" CssClass="button_save"  Text="Add Hostel Fee Fine" Style="float: right; margin-top: 5px; margin-right: 3px" ToolTip="Click here to Add Section." OnClick="Button2_Click" />
        ...
        <div id="divall" runat="server">
            <div class="for_sigle_row_form">
                <label>
                    Hostel Fee Name<span style="color: Red;">* </span>
                </label>
                <asp:TextBox ID="txtFeeName" Text="" onkeypress="return lettersOnly(event)" runat="server" placeholder="Enter Hostel Fee Name Please."></asp:TextBox>
            </div>           
             <div class="for_sigle_row_form">
                <label>
                    Hostel Fee Amount<span style="color: Red;">* </span>
                </label>
        ...
        <table cellpadding="2" id="divgrid" runat="server" cellspacing="0" border="0" style="width: 100%; border-left: none !important; border-bottom: 1px solid #ddd;">
            <tr>
                <td>
                    ...
                    <asp:GridView ID="griview_hostelFee" runat="server" EmptyDataText="No data found !" BorderWidth="0" GridLines="None" CssClass="stm" HeaderStyle-Height="30px"
                        ...
                        Width="100%" OnPageIndexChanging="griview_hostelFee_PageIndexChanging" OnRowCommand="griview_hostelFee_RowCommand" OnRowDataBound="griview_hostelFee_RowDataBound">
