...
public partial class BranchPanel_Student_Registration_StudentNewReg : System.Web.UI.Page
{
    ...
    protected void btnforupdateorsave_Click(object sender, EventArgs e)
    {
        ...
        if (Count == 0)
        {
            ...
            SqlParameter[] Param = new SqlParameter[116];
            ...
            Param[115] = new SqlParameter("@RIDForupdate", Request.QueryString["RID"]);
            int intresult = Objdut.ExecuteSqlSP(Param, "[usp_studentRegistrationNew]");
            if (intresult == 1)
            {
                ...
                {
                    string url = "../Fee%20Management/Register_receipt.aspx?RID=" + Request.QueryString["RID"] + "";
