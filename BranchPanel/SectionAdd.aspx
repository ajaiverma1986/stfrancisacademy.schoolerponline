...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="content_pane_cont input_content branch-div-tbl" id="FIELDSET1" runat="server">
        <div class="tbl-top-heading" style="width: 100%; margin-left: 0px">
            <h2>Add Section</h2>
            <asp:LinkButton ID="LinkButton1" runat="server" CssClass="button_save" PostBackUrl="~/BranchPanel/MasterUC/ViewStdsecBy.aspx" Style="float: right; margin-top: 5px; margin-right: 3px">Show Student Section Wise</asp:LinkButton>
            ...
            <tr>
                <td>
                    <div class="for_sigle_row_form">
                        ...
                        <asp:DropDownList ID="ddlFyid" AutoPostBack="true" OnSelectedIndexChanged="ddlFyid_SelectedIndexChanged" runat="server" AppendDataBoundItems="True">
                        </asp:DropDownList>&nbsp;
                        <br />
                    </div>
                    <div class="for_sigle_row_form">
