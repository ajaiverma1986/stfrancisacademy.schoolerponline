...
public partial class BranchPanel_shortlisted_student_list : System.Web.UI.Page
{
    ...
    private void Fill_Grid()
    {
        ...
        {
            grdforsortlistedstudent.DataSource = ds.Tables[0];
            grdforsortlistedstudent.DataBind();
            hfpages.Value = ds.Tables[1].Rows[0]["pages"].ToString();
        }
        else
        {
            grdforsortlistedstudent.EmptyDataText = "No Record Found";
            grdforsortlistedstudent.DataBind();
        }
