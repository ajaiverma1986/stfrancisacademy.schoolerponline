<%@ Page Title="" Language="C#" MasterPageFile="~/BranchPanel/MasterPage.master" AutoEventWireup="true" CodeFile="student-selection.aspx.cs" Inherits="BranchPanel_Student_Registration_student_selection" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="branch-div-tbl">
        <div class="content_pane_cont input_content" id="contentPane">
            ...
            <div class="for_sigle_row_form" style="margin-top:-12px !important;">
                ...
                <input id="btnonlyreject" class="button_save" type="submit" style="border-radius: 0px ! important; display: block; float: left;margin-left:10px" onclick="return false;" value="Reject" />
        ...
        <div class="searchbar containerHeadline">
            <div class="clear"></div>
            <asp:TextBox ID="txtfromdate" runat="server" onkeypress="return false" placeholder="From Date" Width="67px" ></asp:TextBox>
            <asp:TextBox ID="txttodate" runat="server" onkeypress="return false" placeholder="To Date" Width="67px"></asp:TextBox>
             <asp:TextBox ID="txtregnumber" runat="server" placeholder="Registration No" Width="105px"></asp:TextBox>
            <asp:DropDownList ID="ddlparentqualification" runat="server" Width="212" Height="31px">
                    </asp:DropDownList>
            <asp:DropDownList ID="ddlsecondaryparenthighestqualification" runat="server" Width="224px" Height="31px">
                    </asp:DropDownList>
            <asp:TextBox ID="txtgaurdianmobileno" onkeypress="return isNumberKey(event)" MaxLength="10" runat="server" placeholder="Parent Mobile No" Width="110px"></asp:TextBox>
             <asp:TextBox ID="txtpreviouspercentage" onkeypress="return isNumberKey(event)" MaxLength="3" runat="server" placeholder="Previous Percentage" Width="166px"></asp:TextBox>
            <asp:DropDownList ID="ddlclass" runat="server" Width="108px" Height="31px">
            </asp:DropDownList>
            <asp:DropDownList ID="ddlpparentincome" runat="server" Width="220px" Height="31px" style="margin-left:0px">
            ...
            <asp:DropDownList ID="ddlstatus" runat="server" Width="170px" Height="31px">              
             ...
             <asp:DropDownList ID="ddlfyear" runat="server" Width="108px" Height="31px">     
            </asp:DropDownList>
    ...
    <div class="divnorecordfound" id="divrecordfound" style="margin-left: 480px; display: none" runat="server">
            <label style="font-size: 15px; color: red">Sorry Selected Candidate list  not found.</label>
        </div>
    ...
    <script type="text/javascript">
        var pagesize = 100, pageno = 1,Send = 0, Fromdate = '', maxincome = '', minincome = '', Primaryparentincome = 0, IsShortListed = 0, IsRejected = 0, IsWaiting = 0, Secondaryparentincome = 0, percentage = '', PrimaryHighestQualification = 0, Secondaryparentqualification = 0, Todate = '', cast = 0, Applyingforclass = 0, ParentMobileNo = '', Registrationnumber = '', Fyid = 1, ClassId = 0, CssClass = '', TrForAppend = '', AllRID = '', IsUpdate = 0,IsAdmissionTaken=1;
        //When
        ...
        $(document).ready(function () {
            ...
            $('#btnselectandsendsms').click(function () {
                var confirmstatus = confirm('Are you sure you want to shortlist & send the sms to the selected student\nfor admission.?');
                if (confirmstatus == true) {
                    ...
                    if (Send != 0) {
                        ...
                        alertify.error('No Candiate are shortlisted.');
                        return false;
                    }
                    BindGrid();
                }
            ...
            $('#btnonlyreject').click(function () {
                var confirmstatus = confirm('Are you sure you want to reject the selected student.?');
                if (confirmstatus == true) {
                    IsUpdate = 2;
                    GetAllRID();
                    BindGrid();
        ...
        function SendFeeMsg(ASAID) {
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "student-selection.aspx/sendFeeRemainder",
                data: "{'ASAID':'" + ASAID + "'}",
                dataType: "json",
                success: function (data) {
                    if (data.d == '5') {
                        alert('Msg Send of Registered Admission of Student.');
                        return false;
                    }
                    else if (data.d == '2') {
                        alert('Mobile No not found, please update No.');
                        return false;
                    }
                    else if (data.d == '3') {
                    alert('Mobile No not found of some student.');
                    return false;
                    } 
                }
            });
        ...
        function ClearAll() {
            Fromdate = '',Fyid=1,IsAdmissionTaken=1, Primaryparentincome = 0, Secondaryparentincome = 0, percentage = '', PrimaryHighestQualification = 0, Secondaryparentqualification = 0, Todate = '', cast = 0, Applyingforclass = 0, ParentMobileNo = '', Registrationnumber = '';
            $('#ctl00_ContentPlaceHolder1_txtfromdate,#ctl00_ContentPlaceHolder1_txtpreviouspercentage,#ctl00_ContentPlaceHolder1_txtgaurdianmobileno,#ctl00_ContentPlaceHolder1_txttodate,#ctl00_ContentPlaceHolder1_txtregnumber').val('');
            $('#ctl00_ContentPlaceHolder1_ddlstatus,#ctl00_ContentPlaceHolder1_ddlsincome,#ctl00_ContentPlaceHolder1_ddlpparentincome,#ctl00_ContentPlaceHolder1_ddlsecondaryparenthighestqualification,#ctl00_ContentPlaceHolder1_ddlcategory,#ctl00_ContentPlaceHolder1_ddlparentqualification').val('0');
