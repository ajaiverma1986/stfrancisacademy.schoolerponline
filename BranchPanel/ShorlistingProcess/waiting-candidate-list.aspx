<%@ Page Title="" Language="C#" MasterPageFile="~/BranchPanel/MasterPage.master"
     AutoEventWireup="true" CodeFile="waiting-candidate-list.aspx.cs" Inherits="BranchPanel_ShorlistingProcess_waiting_candidate_list" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="branch-div-tbl">
        ...
        <div class="searchbar containerHeadline">
            ...
            <asp:TextBox ID="txttodate" runat="server" onkeypress="return false" placeholder="To Date" Width="68px"></asp:TextBox>
             <asp:TextBox ID="txtregnumber" runat="server" placeholder="Registration No" Width="101px"></asp:TextBox>
            ...
            <asp:DropDownList ID="ddlpparentincome" runat="server" Width="223px" Height="31px" style="margin-left:0px">
              ...
              <asp:DropDownList ID="ddlsincome" runat="server" Width="237px" Height="33px">
              ...
              <asp:DropDownList ID="ddlcategory" runat="server" Width="146px" Height="33px">
            ...
            <label style="font-size: 15px; color: red">Sorry waiting candidate list not found.</label>
        </div>
                    </div>                
                </div>
            </div>
    ...
    <script type="text/javascript">
        var pagesize = 3, pageno = 1, Fromdate = '', maxincome = '', minincome = '', IsShortListed = 0, IsRejected = 0, IsWaiting = 0, Primaryparentincome = 0, Secondaryparentincome = 0, percentage = '', PrimaryHighestQualification = 0, Secondaryparentqualification = 0, Todate = '', cast = 0, Applyingforclass = 0, ParentMobileNo = '', Registrationnumber = '', Fyid = 1, ClassId = 0, CssClass = '', TrForAppend = '', AllRID = '', IsUpdate = 0,IsAdmissionTaken = 1;
        //When 
