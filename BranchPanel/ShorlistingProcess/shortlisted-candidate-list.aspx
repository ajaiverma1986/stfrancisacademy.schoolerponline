<%@ Page Title="" Language="C#" MasterPageFile="~/BranchPanel/MasterPage.master" AutoEventWireup="true" CodeFile="shortlisted-candidate-list.aspx.cs" Inherits="BranchPanel_ShorlistingProcess_shortlisted_candidate_list" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="clear"></div>
    <div class="branch-div-tbl">
        <div class="content_pane_cont input_content" id="contentPane">
            <div class="tbl-top-heading">
                <h2>Shortlist Candidate list </h2>
                <div class="upload">
            ...
            <div class="for_sigle_row_form" style="margin-top:-12px !important;">
                <input id="btnselectandsendsms" class="button_save" type="submit" style="border-radius: 0px ! important; display: block; float: left;" onclick="return false;" value="Send Message For Admission" />               
        ...
        <div class="searchbar containerHeadline">
            ...
            <asp:DropDownList ID="ddlsecondaryparenthighestqualification" runat="server" Width="227px" Height="31px">
                    </asp:DropDownList>
            <asp:TextBox ID="txtgaurdianmobileno" onkeypress="return isNumberKey(event)" MaxLength="10" runat="server" placeholder="Parent Mobile No" Width="112px"></asp:TextBox>
            ...
            <asp:DropDownList ID="ddlclass" runat="server" Width="110px" Height="31px">     
            </asp:DropDownList>
        ...
        <div class="divnorecordfound" style="margin-left: 480px; display: none">
            <label style="font-size: 15px; color: red">Sorry Shortlist Candidate list not found.</label>
        </div>             
                </div>
            </div>
    ...
    <script type="text/javascript">
        var pagesize = 100, pageno = 1, Fromdate = '', maxincome = '', minincome = '', IsShortListed = 0, IsRejected = 0, IsWaiting = 0, Primaryparentincome = 0, Secondaryparentincome = 0, percentage = '', PrimaryHighestQualification = 0, Secondaryparentqualification = 0, Todate = '', cast = 0, Applyingforclass = 0, ParentMobileNo = '', Registrationnumber = '', Fyid = $('#ctl00_ContentPlaceHolder1_ddlfyear').val(), ClassId = 0, CssClass = '', TrForAppend = '', AllRID = '', IsUpdate = 0, IsAdmissionTaken = 1;
        //When 
        ...
        $(document).ready(function () {
            ...
            $('#btnselectandsendsms').click(function () {
                var confirmstatus = confirm('Are you sure you want send the sms to the checked student\nfor admission.?');
        ...
        function SendFeeMsg(ASAID) {
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "shortlisted-candidate-list.aspx/sendFeeRemainder",
                data: "{'ASAID':'" + ASAID + "'}",
                dataType: "json",
                success: function (data) {
                    if (data.d == '5') {
        ...
        function ClearAll() {
            Fromdate = '', Fyid = 0, IsAdmissionTaken = 1, Primaryparentincome = 0, Secondaryparentincome = 0, percentage = '', PrimaryHighestQualification = 0, Secondaryparentqualification = 0, Todate = '', cast = 0, Applyingforclass = 0, ParentMobileNo = '', Registrationnumber = '';
            ...
            $('#ctl00_ContentPlaceHolder1_ddlstatus,#ctl00_ContentPlaceHolder1_ddlsincome,#ctl00_ContentPlaceHolder1_ddlpparentincome,#ctl00_ContentPlaceHolder1_ddlcategory,#ctl00_ContentPlaceHolder1_ddlsecondaryparenthighestqualification,#ctl00_ContentPlaceHolder1_ddlparentqualification').val('0');
