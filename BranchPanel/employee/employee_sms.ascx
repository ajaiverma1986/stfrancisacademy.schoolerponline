<%@ Control Language="C#" AutoEventWireup="true" CodeFile="employee_sms.ascx.cs" Inherits="BranchPanel_employee_employee_sms" %>
...
<div class="student-photo_frame">
    ...
    <div style="float: left;">
        <div class="user-deatils">
            <dl>
                <asp:Label ID="lblname" runat="server">Sms Management</asp:Label>
            </dl>
        </div>
    </div>
    <div class="clear">
    ...
    <div style="margin-bottom: -3px; padding-bottom: 8px; margin-top: 10px;">
        <div style="margin-bottom: -3px; margin-top: 10px;">
             ...
             <asp:LinkButton ID="lbtnshorlistlist" runat="server" Style="font-size: 10pt; font-weight: bold; background-color: none; color: black; text-decoration: none; margin-left: 20px !important;" Text="SMS History" class="activeshortlistlist" 
            ...
            <asp:LinkButton ID="lbtncreatenewshortlist" runat="server" Style="margin-left: 15px!important; font-size: 10pt; font-weight: bold; background-color: none; color: black; text-decoration: none" Text="Send SMS" class="activecreateshortlist"
