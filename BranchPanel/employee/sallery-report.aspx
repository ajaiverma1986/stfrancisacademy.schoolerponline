...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="content_top">
        <ul>
            ...
            <li style="background: none;"><a href="../employee-list.aspx">Employee List</a></li>
            <li style="background: none;"><a class="active" href="#">Sallery Report</a></li>
        </ul>
    </div>
    ...
    <div class="content_pane_cont input_content" id="contentPane">
        ...
        <asp:UpdatePanel ID="updtpnl" runat="server" UpdateMode="Always">
            <ContentTemplate>
                        ...
                        <td align="left" colspan="12" style="width: 100%; padding-left: 0px; padding-right: 0px;">
                            <asp:GridView runat="server" ID="gvdetails" ShowHeader="true" AutoGenerateColumns="false"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderStyle-Width="130px" HeaderText="Approve Unpaid Leave" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:Label ID="lbltotalunpaidleave" runat="server" Text='<%# Eval("totalunpaidleave") %>' CssClass="lbltotalunpaidleave"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderStyle-Width="130px" HeaderText="Unapprove Unpaid Leave" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderStyle-Width="110px" HeaderText="Paid Leave" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderStyle-Width="95px" HeaderText="Half Days" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderStyle-Width="111px" HeaderText="Admin Effective Days" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:Label ID="txteffectiveday" runat="server" Text='<%# Eval("effectivedays_changebyadmin") %>' CssClass="txttotaleffectiveday"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                ...
                <asp:Button ID="btnback" runat="server" Text="Back" Visible="false" CssClass="button2" OnClick="btnback_Click" Style="cursor: pointer; margin-left: 20px !important; margin-top: 10px !important" />
            </ContentTemplate>
        </asp:UpdatePanel>
    </div>
</asp:Content>