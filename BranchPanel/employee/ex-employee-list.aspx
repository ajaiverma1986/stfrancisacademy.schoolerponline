<%@ Page Title="" Language="C#" MasterPageFile="~/branchpanel/MasterPage.master" AutoEventWireup="true" CodeFile="ex-employee-list.aspx.cs" Inherits="branchpanel_employee_ex_employee_list" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        var ctr = 1;
        function pageLoad() {
            document.title = 'Ex-Employee List';
        ...
        function add_Row() {
            ...
            var newTr = '<tr ><td style="border: 1px solid #CCCCCC!important;text-align: center;"><span style="width:120px;text-transform:none!important"  id=' + txtqualification +
        ...
        function GetOfferedEmpList() {
            ...
            $.ajax({
                type: "POST",
                url: "ex-employee-list.aspx/GetAppointedEmpList",
                    ...
                    if (viewtype == 0) {
                        ...
                        if (data.d.length > 0) {
                            ...
                            for (var i = 0; i < data.d.length; i++) {
                                ...
                                $(row).find(".date").html(data.d[i].dateforstatus);
        ...
        function OnSuccessReturn(data) {
            $.each(data.d, function (key, value) {
                ...
                $("#lblPqualification").text(value.pqualificaton);
    ...
    <div class="content_top" style="margin-bottom: 20px;">
        <ul>
            ...
            <li style="background: none;"><a class="active">Ex Employee List</a></li>
        </ul>
    ...
    <div class="content_pane_cont input_content" id="contentPane">
        ...
        <div id="boxid" runat="server" style="margin-left: 250px !important; margin-bottom: 10px !important;">
            <table id="tbllde">
                <tr>
                    ...
                    <td valign="top" align="left">
                        <div class="conductedlecture236 fourthbox" style="margin-left: 11px; border: 1px solid #15E6B5;">
                            <asp:Label runat="server" ID="Label5" Text="Terminated: " Font-Bold="true" ForeColor="#14879e"></asp:Label>
                            <asp:Label ID="lblterminated" runat="server" Text="0" Font-Bold="true" ForeColor="#14879e"></asp:Label>
                        </div>
                    </td>
                    <td valign="top" align="left">
                        <div class="conductedlecture236 fourthbox" style="margin-left: 11px; border: 1px solid #15E6B5;">
                            <asp:Label runat="server" ID="Label11" Text="Resigned: " Font-Bold="true" ForeColor="#14879e"></asp:Label>
                            <asp:Label ID="lblresigned" runat="server" Text="0" Font-Bold="true" ForeColor="#14879e"></asp:Label>
                        </div>
                    </td>
                </tr>
            </table>
                ...
                <td colspan="2" class="containerHeadline" style="width: 100%">
                    ...
                    <div style="float: left; width: 100%;">
                        ...
                        <asp:DropDownList ID="ddlsearchbystatus" runat="server" Width="115px" Style="float: right" Font-Size="12px">
                            ...
                            <asp:ListItem Value="3" Text="Terminated"></asp:ListItem>
                                        ...
                                        <div style="float: left;">
                                            <div class="user-deatils1">
                                                <asp:LinkButton ID="lbtn3" runat="server" Text='<%# Bind("name") %>' CssClass="swet"
                                                    ToolTip="Click here to Update the Employee profile." Enabled="false">
                                                </asp:LinkButton>
                                            ...
                                            <div class="user-deatils1">
                                                <dt>Date:</dt>
                                                <asp:Label ID="lbldateofactivityregin" runat="server" Text='<%#  Eval("date")  %>' CssClass="date"></asp:Label>
                                                </span>
                                            </div>
                ...
                <td>
                    <div id="divMessage" class="showpopup" style="text-align: center; display: none">
                        ...
                        <div style="text-align: right;">
                            <div style="width: 50px; height: 33px; float: right; text-align: center; margin: 20px 21px 0px 0px; margin-right: 30px">
                        ...
                        <div style="width: 95%; margin: 10px;">
                            <table class="showpopup2" style="background-color: white; vertical-align: top">
                                ...
                                <tr>
                                    <td class="t1"><span>To:</span></td>
                                    <td class="t2" style="padding-bottom: 5px">
                                        <asp:Label ID="lblformobile" Style="height: 24px; width: 250px;" runat="server"></asp:Label>
                                    </td>
                                </tr>
