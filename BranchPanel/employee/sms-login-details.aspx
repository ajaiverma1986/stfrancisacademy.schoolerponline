<%@ Page Title="" Language="C#" MasterPageFile="~/branchpanel/MasterPage.master" AutoEventWireup="true" CodeFile="sms-login-details.aspx.cs" Inherits="branchpanel_employee_sms_login_details" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#ctl00_ContentPlaceHolder1_txtmobileno').on('change keyup', function () {
                FillField();
                BindGridAfterSearch();
                return false;
            });
            ...
            $('#ctl00_ContentPlaceHolder1_btnsend').click(function () {
                ...
                if (parseInt(trlength) > 0) {
                    alertify.confirm("Are you sure you want to send the sms to checked employee", function (e) {
                        if (e) {
                            ...
                            GetDetilsAndSendSmsOrEmail(empid, "1");
                        }
                        else {
        ...
        function CheckAllSmsEmp(Checkbox) {
            var chstatus = $("#ctl00_ContentPlaceHolder1_gridforsendmailorsms_chkboxsmsSelectAll").prop("checked");
            var GridVwHeaderChckbox = document.getElementById("<%=gridforsendmailorsms.ClientID %>");
            for (i = 1; i < GridVwHeaderChckbox.rows.length; i++) {
                if (chstatus == true) {
                    $(".chkallforsms").find("input[type='checkbox']").prop("checked", true);
                }
                if (chstatus == false) {
        ...
        function GetDetilsAndSendSmsOrEmail(seletedemployee, mode) {
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "sms-login-details.aspx/GetDetilsByEid",
        ...
        function FillField() {
            ...
            mobileno = $('#ctl00_ContentPlaceHolder1_txtmobileno').val();
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.d.length > 0) {
                        ...
                        $('#ctl00_ContentPlaceHolder1_btnsend').css("display", "none");
                    }
                    call_progressbar("end");
                },
                error: function (result) {
    ...
    <div class="content_top">
        <ul>
            ...
            <li style="background: none;"><a class="active" href="#">SMS Login Details</a></li>
        </ul>
    </div>
            ...
            <tr>
                <td class="containerHeadline" style="width: 100%">
                    <div style="float: right; width: 100%;">
                        ...
                        <asp:TextBox ID="txtmobileno" runat="server" Width="120px" placeholder="Mobile No."> </asp:TextBox>
                        ...
                        <asp:Button ID="btnsend" runat="server" Text="SMS" CssClass="button2" Style="float: right !important; color: white !important; width: 70px !important; height: 30px !important;" />
                    </div>
                </td>
            </tr>
                ...
                <td align="left" style="width: 100%; padding-left: 0px; padding-right: 0px;">
                    <asp:GridView ID="gridforsendmailorsms" AutoGenerateColumns="false" Width="100%" runat="server"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Name" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="250px">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Mobile No." ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="150px">
                                <ItemTemplate>
                                    <asp:Label ID="lblmobileno" Text='<%# Eval("mobile") %>' runat="server" CssClass="mobile"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField>
                                <HeaderTemplate>
                                    <asp:CheckBox ID="chkboxsmsSelectAll" CssClass="chkboxsmsSelectAlljquery" runat="server" Style="padding: 6px 3px 3px 30px;" onclick="CheckAllSmsEmp(this);" />
                                    <asp:Label ID="lbltextsmsforall" runat="server" Text="Check For Send Sms" Style="margin-left: 7px ! important"></asp:Label>
                                </HeaderTemplate>
                                <ItemTemplate>
                                    <asp:CheckBox ID="checkboxsmsrowwise" Style="display: block" runat="server" CssClass="checkboxsmsjquery chkallforsms" />
                                </ItemTemplate>
