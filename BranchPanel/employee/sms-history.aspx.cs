...
public partial class branchpanel_employee_sms_history : System.Web.UI.Page
{
    ...
    private void fillgrid()
    {
        ...
        ds = ObjUtl.GetDataSetSP(param1, "get_sms_history");
        ...
        {
            gridforsmshistory.EmptyDataText = "Currently, SMS history is not available.";
