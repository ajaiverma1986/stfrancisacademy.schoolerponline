...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="content_top">
        <ul>
            ...
            <li style="background: none;"><a class="active" href="#">Advance Sallery</a></li>
        </ul>
    </div>
    ...
    <div class="content_pane_cont input_content" id="contentPane">
        ...
        <div class="for_sigle_row_form boxti shadow1" id="divpaynow" style="background-color: #F1F1F1; margin-left: 227px; width: 563px; min-height: 50px; box-shadow: 0 0 5px rgba(152, 150, 150, 0.65); margin-top: 10px !important; margin-bottom: 50px !important; display: block">
            ...
            <table class="paytable">
                <tr>
                    ...
                    <td style="text-align: left">
                        <asp:TextBox ID="txtempname" runat="server" MaxLength="100" ReadOnly="true"></asp:TextBox></td>
                </tr>
            ...
            <div class="for_sigle_row_form" style="margin-left: -68px">
                ...
                <asp:Button ID="btnpay" runat="server" Text="Pay" CssClass="button2" Style="cursor: pointer" OnClick="btnpay_Click" />
            </div>
        </div>
    </div>
</asp:Content>