                    ...
                    <ItemTemplate>
                        ...
                        <div style="width: 730px; height: 100%; border: solid 1px black; padding: 10px 10px 10px 10px; margin-bottom:2px;">
                            ...
                            <table style="width: 100%; border: none;margin-bottom:8px;font-weight:bold;font-size:14px;">
                                <tbody><tr style="background-color: #;height: 25px;">
                                ...
                                <tr style="display:none">
                                 ...
                                 <tr>
                                    <td colspan="7" style="width: 100%; border: none;">
										...
										<center><h2><u>ANNUAL EXAM-2022-23</u></h2></center>
										</br>
										<Left><b>From- 22/02/2023</b3></Left>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<Right><b>To- 14/03/2023</b3></Right></br>
										<Left><b>Exam Timing (For I to IX): 8:30 a.m.- 10:30 a.m.  and  For Nursery to UKG: 10:30 a.m.- 12:30 p.m. </Left>
                                ...
                                <tr >
                                    <td colspan="8" style="width: 100%; border: none; line-height: 25px;">
                                        ...
                                        <table style="width: 100%; font-size: 16px; border: none">
											...
											<tr>
                                   <td style="text-align: right; border: none;width:100%" colspan="3">
                                         <img id="grdSTDResult_ctl02_Image3" class="schoollogo" src="../images/sibipin.jpg" style="height:60px;width:20%;border-width:0px;">
                                    </td>
                                           
                                            <tr>
                                                <td style="width: 105%; border: none;">Signature of Candidate : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Signature of Principal </td>
