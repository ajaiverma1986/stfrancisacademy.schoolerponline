<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportCard_Term.aspx.cs" Inherits="BranchPanel_Exams_ReportCard_Term" %>
...
<body>
    <form id="form1" runat="server" style="font-size: 18px;">
            ...
            <Columns>
                <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                    ...
                    <ItemTemplate>
                        ...
                        <div style="width: 840px; height: 1228px; border: solid 3px black; padding: 10px 10px 10px 10px;">
                            <table style="width: 100%; text-align: center; border: none; margin-top: 2px;">
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center; border: none;width:1%" colspan="1">                                     
                                          ...
                                          <!--  <h1 style="margin: 0"><span id="SpScool" runat="server"></span></h1>
                                            <h3 style="margin: 0; font-size: 16px"><span id="SAddress" runat="server"></span></h3>
                                            <h3 style="margin: 0; font-size: 16px"><span id="SSAddress" runat="server"></span></h3>--!>
                                            <h3 style="margin: 0; font-size: 16px"><span id="affhead" runat="server">Affiliation No:</span><span id="SchoolAffia" runat="server"></span><br />
                                ...
                                <tr>
                                   <!-- <td colspan="3" style="border:none!important">
                                         <div style="border-bottom: solid 2px black; width: 100%; font-size: 16px; height: 5px"></div><br/>
                            ...
                            <table style="width: 100%; border: none;margin-bottom:8px;font-weight:bold;font-size:18px;">
                                <tr style="background-color: #9fdf9f;height: 25px;">
                                    <td style="border: none; width: 5%; text-align:right">Name:</td>
                                    <td style="border: none; font-weight: 800;width: 20%;"><span id="SpName" runat="server">Ist</span></td>
                                    ...
                                    <td style="border: none; width: 15%">Session 2023-24</td>
                                     
                                    
                                </tr></table>
                            <table style="border: none;width:100%;font-weight:bold;font-size:18px;">
                                            <tr style="background-color: #9fdf9f;height: 25px;">
                                     ...
                                     <td style="border: none; width: 18%; text-align:right">Father’s Name:  </td>
                            ...
                            <table style="width: 100%; border: none">
                                ...
                                <tr>
                                    <td colspan="8" style="width: 100%; border: none; line-height: 22px;">
                                        <br />
                                        <table style="width: 100%; font-size: 17px;font-weight:bold;">
                                            <tr>
                                                <td style="width: 18.5%;border: 2px solid black;"><b>Subjects</b></td>
                                                <td style="width: 30.5%; text-align: center;border: 2px solid black;"><b><span id="SpTerm" runat="server">First Term </span></b></td>
                                                <td style="width: 30%; text-align: center;border: 2px solid black;"><b>Term - II </b></td>
												<td style="width: 20.5%; text-align: center;border: 2px solid black;"><b>Final</b></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="8" style="width: 100%; border: none;font-size:16px;">
                                ...
                                <tr>
                                    <td colspan="8" style="width: 100%; border: none; line-height: 25px;">
                                        ...
                                        <table style="width: 100%; font-size: 16px; border: none;text-align:left">
											...
											<tr>
                                                <td style="width: 100%; border: none; ">
                                                 <h3> <u>  Results:</u>  Passed / Promoted / Detained in Class</h3>
												 <h3> <u>  Grades: </u></h3>
                                                </td>
                                            ...
                                            <tr>
                                                <td style="width: 100%; border: none">
                                                 <b>A - Very Good (160-200) &nbsp;&nbsp;&nbsp; B - Good (130-159.9)&nbsp;&nbsp;&nbsp; C - Satisfactory( 100-129.9)&nbsp;&nbsp;&nbsp;D-Fair(80-99.9)&nbsp;&nbsp;&nbsp;E -Unsatisfactory(1-79.9)</b>
                                                </td>
                                        ...
                                        <table style="width: 97.5%; font-size: 16px;border:2px solid">
                                            <tr>
                                                <td style="width: 24%; border: none;text-align:center" colspan="1" >
                                                  <center><b>  Seal</b></center>
                                                </td>
                                                <td style="width: 25%; border: none;text-align:center" colspan="1">
                                                   <center>  <b>Class Teacher's Signature<b> <center>
                                                </td>
                                                <td style="width: 25%; border: none;text-align:center" colspan="1">
