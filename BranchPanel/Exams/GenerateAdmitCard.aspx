<%@ Page Language="C#" MasterPageFile="~/BranchPanel/MasterPage.master" AutoEventWireup="true" CodeFile="GenerateAdmitCard.aspx.cs" Inherits="BranchPanel_Exams_GenerateAdmitCard" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <script type="text/javascript">
        $(document).ready(function () {
            $('#txtFromdate').datepicker({ dateFormat: 'dd-mm-yy',minDate:new Date() });
            $('#txtTodate').datepicker({ dateFormat: 'dd-mm-yy', minDate: new Date() });
    ...
    <div class="content_pane_cont input_content branch-div-tbl" id="FIELDSET1" runat="server">
        <div class="tbl-top-heading" style="width: 100%; margin-left: 0px">
            <h2>Student List For Admit Card</h2>
        ...
        <div id="divall" runat="server">
            ...
            <div class="for_sigle_row_form" runat="server" >
                ...
                <asp:TextBox runat="server" ID="txtFromdate" placeholder="From Date" ClientIDMode="Static" Width="125px"></asp:TextBox>
                <asp:TextBox runat="server" ID="txtTodate" placeholder="To Date" ClientIDMode="Static" Width="125px" style="margin-left:20px"></asp:TextBox>
            </div><br />
            ...
            <div class="for_sigle_row_form" runat="server"  style="float:right">
                <asp:Button ID="btnVResult" runat="server" Text="View Admit Card" Visible="false" CssClass="button_save" OnClick="btnVResult_Click" />
            </div>
            <br />
                ...
                <tr>
                    <td>
                        ...
                        <asp:GridView ID="grdHouse" runat="server" EmptyDataText="No data found !" BorderWidth="0" GridLines="None" CssClass="stm" HeaderStyle-Height="30px"
                            ...
                            PagerStyle-Font-Size="15px" PageSize="200" PagerStyle-HorizontalAlign="Right" OnPageIndexChanging="grdHouse_PageIndexChanging"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Result" Visible="false" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
