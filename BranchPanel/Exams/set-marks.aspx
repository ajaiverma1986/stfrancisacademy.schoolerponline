<%@ Page Title="Set Marks" Language="C#" MasterPageFile="~/BranchPanel/MasterPage.master" AutoEventWireup="true" CodeFile="set-marks.aspx.cs" Inherits="BranchPanel_Exams_set_marks" %>
            ...
            <ContentTemplate>--%>
                ...
                <div id="divforsetmarks" style="display: block" runat="server">
                    ...
                    <div style="display: block" id="divforsetmarks2" runat="server">
                        ...
                        <br />
                        <asp:GridView ID="grdsetmarks" runat="server" AutoGenerateColumns="false" GridLines="None" Width="100%" BorderWidth="0" CssClass="containerHeadline">
                            <Columns>
