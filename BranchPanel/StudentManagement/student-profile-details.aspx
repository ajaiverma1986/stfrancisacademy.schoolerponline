<%@ Page Title="" Language="C#" MasterPageFile="~/BranchPanel/MasterPage.master" AutoEventWireup="true" CodeFile="student-profile-details.aspx.cs" Inherits="BranchPanel_StudentManagement_student_profile_details" enableEventValidation="false"%>
   ...
   <div class="branch-div-tbl">
                    ...
                    <asp:FileUpload ID="fileuploaderofparentphotograph" onchange="ShowpImageParentphotograph(this);" runat="server" />&nbsp;
                     <div class="user_phot_frame">
                         <div id="parentfirstphoto" Style="display:none;width:150px; position: absolute; margin-top:-90px" runat="server">
                             <span style="color: black;font-weight:bold;padding-top:20px;"><center><u>Parent Photograph</u></center></span>
     ...
     <script type="text/javascript">
         ...
         $(document).ready(function () {
             ...
             CalculateAge();
             $("#ctl00_ContentPlaceHolder1_txtstudentdob,#ctl00_ContentPlaceHolder1_txtparentdateofbirth,#ctl00_ContentPlaceHolder1_txtsecondaryparentdateofbirth,#ctl00_ContentPlaceHolder1_txtregistrationdate,#ctl00_ContentPlaceHolder1_txtchkddneftrefdate").datepicker({
                 changeMonth: true,
                 changeYear: true,
                 yearRange: '1970:' + year,
                 dateFormat: 'dd MM yy'
             ...
             $('#ctl00_ContentPlaceHolder1_btnforupdateorsave').click(function () {
                 ...
                 else if (parseInt($('#ctl00_ContentPlaceHolder1_ddlpaymentmode').val()) > 1) {
             ...
             $('#ctl00_ContentPlaceHolder1_ddlapplyingforclass').change(function () {
                 ...
                 $.ajax({
                     ...
                     url: "student-profile-details.aspx/BindSectionDDL1",
         ...
         //--------------------function for show/hide text field-----------------------------
         ...
         function BindFieldOnTheBehalfOfCheckUnCheck() {
             $.ajax({
                 type: "POST",
                 url: "student-profile-details.aspx/CheckCheckboxOnTheBehalfOfPermission",
                 data: "{}",
                 contentType: "application/json; charset=utf-8",
                 dataType: "json",
                 async: false,
