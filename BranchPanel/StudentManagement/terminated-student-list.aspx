<%@ Page Title="" Language="C#" MasterPageFile="~/BranchPanel/MasterPage.master" AutoEventWireup="true" CodeFile="terminated-student-list.aspx.cs" Inherits="BranchPanel_StudentManagement_terminated_student_list" %>
...
.tbodypopup {
    ...
    <div class="content_pane_cont input_content" id="contentPane">
        ...
        <div class="divnorecordfound" style="margin-left: 480px; display: none">
            <label style="font-size: 15px; color: red">Sorry Terminated Student list not found.</label>
        </div>
    </div>            
    </div>
     ...
     <script type="text/javascript">
         ...
         function FillDetailsOfStudent() {
             $.ajax({
                 type: "POST",
                 contentType: "application/json; charset=utf-8",
                 url: "terminated-student-list.aspx/FillDetailsOfStudent",
                 data: "{'SAMID':'" + SAMID + "'}",
                 dataType: "json",
                 success: function (data) {
                     if (data.d.length > 0) {
         ...
         function Bindstudentpassout() {
             ...
             $.ajax({
                 type: "POST",
                 contentType: "application/json; charset=utf-8",
                 url: "terminated-student-list.aspx/BindGridByJs",
