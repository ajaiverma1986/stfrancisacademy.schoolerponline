<%@ Page Title="" Language="C#" MasterPageFile="~/BranchPanel/MasterPage.master" AutoEventWireup="true" CodeFile="Promoted-student-list.aspx.cs" Inherits="BranchPanel_StudentManagement_Promoted_student_list" %>
...
.tbodypopup {
    ...
    <div class="content_pane_cont input_content" id="contentPane">
        ...
        <div class="grid-data-resposive">
            ...
            <table width="100%" class="stm stmdetail" border="0" cellspacing="0" cellpadding="0" runat="server" id="CourseGrid">
                <tr class="stm_head">
                    ...
                    <th align="center">Promoted Class</th>
                    <th align="center">Prpmoted Section</th>
        ...
        <div class="divnorecordfound" style="margin-left: 480px; display: none">
            <label style="font-size: 15px; color: red">Sorry Promoted Student list not found.</label>
        </div>
    </div>            
    </div>
     ...
     <script type="text/javascript">
         var Fromdate = '', Todate = '', Admissionnnumber = '', Registrationnumber = '', StudentName = '', Applyingforclass = 0, Status = 0, Parentname = '', ParentMobileNo = '', studentid = 0, Fyid = $('#ctl00_ContentPlaceHolder1_ddlfyear').val();
         ...
         function FillDetailsOfStudent() {
             $.ajax({
                 type: "POST",
                 contentType: "application/json; charset=utf-8",
                 url: "Promoted-student-list.aspx/FillDetailsOfStudent",
                 data: "{'SAMID':'" + SAMID + "'}",
                 dataType: "json",
                 success: function (data) {
                     if (data.d.length > 0) {
         ...
         function Bindstudentpassout() {
             ...
             $.ajax({
                 type: "POST",
                 contentType: "application/json; charset=utf-8",
                 url: "Promoted-student-list.aspx/BindGridByJs",
                 ...
                 success: function (data) {
                     ...
                     if (data.d.length > 0) {
                         for (var i = 0; i < data.d.length; i++) {
                             ...
                             "<td>" + data.d[i].Promoteclass + " </td>" +     //bind grid promote
                             "<td>" + data.d[i].PromoteSecName + " </td>" +
