<%@ Page Title="Shortlisted Candidate List" Language="C#" MasterPageFile="~/BranchPanel/MasterPage.master" AutoEventWireup="true" CodeFile="shortlisted-student-list.aspx.cs" Inherits="BranchPanel_shortlisted_student_list" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        var datefrom = '', dateto = '', status = '2', classid = '', mobileno = '', regno = '', name = '', studentstatus = '', fyid = '', pageno = 1, pagecount = 1;
        var pagesize = 20;
        function pageLoad() {
        ...
        a(document).ready(function () {
            a(document).on("click", "[id*=grdforsortlistedstudent] [id*=lnkview]", function () {
            ...
            a(document).on("click", "[id*=grdforsortlistedstudent] [id*=lbRegNo]", function () {
                var id;
                id = $(this).parent('div').find('.cllblpmid').text();
        ...
        function GetStudentlist() {
            ...
            $.ajax({
                ...
                success: function (data) {
                    var srno = 1;
                    $("[id*=grdforsortlistedstudent] tr:gt(1)").remove();

                    if (data.d.length > 0) {
                        for (var i = 0; i < data.d.length; i++) {
                            var row = $("[id*=grdforsortlistedstudent] tr:eq(1)").clone(true);
                            $("[id$=grdforsortlistedstudent]").append(row);
                    ...
                    $("[id*=grdforsortlistedstudent] tr").show();
                    $("[id*=grdforsortlistedstudent] tr:eq(1)").hide();
                },
                error: function (result) {
                    alert("Error");
                }
    ...
    <div class="content_top">
        <ul>
            ...
            <li style="background: none;"><a class="active" href="#">Shortlisted Candidate List</a></li>
        </ul>
    </div>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 0px; box-shadow: 1px 1px 2px 0 rgba(0, 0, 0, 0.3);"
        ...
        <tr>
            <td colspan="10" class="containerHeadline">
                ...
                <div style="float: left; width: 994px; margin-left: 10px">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td align="left" colspan="12" style="width: 100%; padding-left: 0px; padding-right: 0px;">
                <asp:GridView ID="grdforsortlistedstudent" runat="server" ShowHeader="true" AutoGenerateColumns="false"
