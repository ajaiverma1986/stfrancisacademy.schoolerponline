<%@ Page Title="Rejected Candidate List" Language="C#" MasterPageFile="~/BranchPanel/MasterPage.master" AutoEventWireup="true" CodeFile="rejected-student-list.aspx.cs" Inherits="BranchPanel_rejected_student_list" %>
