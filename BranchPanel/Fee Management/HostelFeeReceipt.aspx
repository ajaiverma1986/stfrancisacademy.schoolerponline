<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HostelFeeReceipt.aspx.cs" Inherits="BranchPanel_Fee_Management_HostelFeeReceipt" %>
                ...
                <%--<table style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td style="width:60%; text-align:center">
                            <span style="font-size: 20px; text-align: center; font-family: Arial; color: #424546; font-weight: 600;">
                                <span runat="server" id="schoolName2" style="font-size: 16px;"></span></span>
                        ...
                        <td style="width:25%">
                            <div class="receiptwrapper_add" style="float: right; text-align:right; font-size: 12px; font-family: Arial; color: black;">
                                <p id="inscontact" runat="server" style="padding: 0px; margin: 2px 0;">Ph.: 
                                    <asp:Label runat="server" ID="lblcontact"></asp:Label></p>
                                <p id="inscontact2" runat="server" style="padding: 0px; margin: 2px 0;">Mob : 
                                    <asp:Label runat="server" ID="lblMob"></asp:Label></p> 
                       ...
                       <table style="width:100%">
                           <tr>
                               ...
                               <td>
                                   <div style="text-align: center; font-weight: 600; font-family: Arial; color: #656d70;">Payment Receipt</div>
                               </td>
                               <td>
                           ...
                           <tr>
                               <td colspan="3">
                                   <span style="float: right; font-size: 14px; font-style: italic; font-family: Arial; color: #424546;">Fee Month : <span id="Span24" runat="server" style="font-weight: 600;"></span></span></td>
                           </tr>
                       </table>
...
<%--                 <p style="font-size:14px; float:left; font-family:Arial; color:#424546; width:80px; margin:4px 0 10px;">Profile No . </p>
 ...
 HeaderStyle-CssClass="header" RowStyle-CssClass="rows">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Particular">                            
                            <ItemTemplate>
                                <asp:Label ID="Label1" runat="server" Text='<%# Bind("HostelFeeName") %>'></asp:Label>
                            </ItemTemplate>
                            <ItemStyle Font-Size="Small" CssClass="BorderRight" Width="65%"/>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Amount(Rs.)">
                            <ItemTemplate>
                                <asp:Label ID="Label2" runat="server" Text='<%# Bind("HostelFeeAmt") %>'></asp:Label>
                            </ItemTemplate>
  ...
  <dl style="float:left; font-size:13px;  font-family:Arial; color:#424546; margin:3px 0 10px; font-weight:600; border-bottom:1px solid #5f6162;"><span id="Span6"  style="margin-left:10px"  runat="server"></span></dl>
    ...
    <p style="font-size:14px; float:left; font-family:Arial; color:#424546; width:135px; margin:3px 0 10px; display:none">Bank TransactionID :</p>
  ...
  <table visible="false" id="chequedetails" runat="server" width="100%" border="0"  cellpadding="0" cellspacing="0" style="margin:0px 0px 0 0px; float:left; font-size:14px; color:#4f4848;   font-family:Arial;">
      <tr style="float:left;">
  ...
  <div style="clear:both;"></div>
    ...
    <dl style="float:left; font-size:13px;  font-family:Arial; color:#424546; margin:25px 0 10px; font-weight:600; border-bottom:1px solid #5f6162; width:40%;"><span id="Span11" runat="server"></span></dl>
   ...
   <dt style"clear:both;"></dt>
                   ...
                   <td style="visibility:hidden" style="width:50%">
                    ...
                    <tr>
                        ...
                        <td style="width:60%; text-align:center">
                            <span style="font-size: 15px; text-align: center; font-family: Arial; color: #424546; font-weight: 600;"><span id="SchoolName" runat="server"></span></span>
                           <br /> <span id="H1" runat="server" style="font-size: 10px; font-weight:700; text-align: center; font-family: Arial; color: #424546;">
                        ...
                        <td style="width:25%">
                           ...
                           <table style="width: 100%; text-align:center">
                               <tr>
                                   <td><span style="float: left; margin: 0px 0 8px; font-size: 10px; font-style: italic; font-family: Arial; color: #424546;">Receipt No: <span id="recieptno2" runat="server" style="font-weight: bold;font-size:10px"></span></span></td>
                                   <td><span style="text-align: center; font-weight: 600; font-family: Arial; color: #656d70;">Payment Receipt</span></td>
                                   <td><span style="float: right; margin: 0px; font-size: 10px; font-style: italic; font-family: Arial; color: #424546;">Date: <span id="recieptdate2" runat="server" style="font-weight: 600;font-size:10px"></span></span></td>
                               </tr>
                               <tr>
                                   <td colspan="3">
                                       <span style="float: right; margin: 0px; font-size: 10px; font-style: italic; font-family: Arial; color: #424546;">Fee Month : <span id="Span40" runat="server" style="font-weight: 600;font-size:10px"></span></span>
                                   </td>
                               </tr>
                           </table>
           <div style="clear:both;"></div>
 ...
 HeaderStyle-CssClass="header" RowStyle-CssClass="rows">
  ...
  <dl style="float:left; font-size:13px;  font-family:Arial; color:#424546; margin:3px 0 10px; font-weight:600; border-bottom:1px solid #5f6162;"><span id="Span55" style="margin-left:10px" runat="server"></span></dl>
    ...
    <p style="font-size:14px; float:left; font-family:Arial; color:#424546; width:106px; margin:3px 0 10px;">Payment Mode:</p>
    <dl style="float:left; font-size:13px;  font-family:Arial; color:#424546; margin:3px 0 0px; font-weight:600;  width:25%;"><span id="Span56" runat="server">Cash</span></dl>
  ...
  <table id="chequedetails1" visible="false" runat="server" width="100%" border="0"  cellpadding="0" cellspacing="0" style="margin:0px 0px 0 0px; float:left; font-size:14px; color:#4f4848;   font-family:Arial;">
      <tr style="float:left;">
    <td colspan="2" align="left" style="font-size:14px; color:#4f4848; float:left;  font-family:Arial; padding:2px 0 0px 0px; font-weight:600;">Cheque Details: </td>
    </tr>
  ...
  <div style="clear:both;"></div>
    ...
    <div style="float:left; width:35%; margin-top:24px;">
    <p style="float:left; font-size:14px; font-style:italic; font-family:Arial; margin-right:4px; margin-top:10px; color:#424546;">Received By: </p>
    <dl style="float:left; font-size:13px;  font-family:Arial; color:#424546; margin:25px 0 10px; font-weight:600; border-bottom:1px solid #5f6162; width:40%;"><span id="Span61" runat="server"></span></dl>
