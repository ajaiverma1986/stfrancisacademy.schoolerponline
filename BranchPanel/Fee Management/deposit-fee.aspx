...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        var year = 2050;
        var ASAID = 0, name = '',money = 0, sectionID = 0,admission = '', fyid = 0, classid = 0, duefromdate = '', duetodate = '', pageno = 1, pagesize = 100, pagecount = 1;
        var myData = {};
        $(document).ready(function () {
            ...
            $('#BtnPayNow').click(function () {
                ...
                if ($('#txtPayable').val() != $('#txtAmount').val()) {
                    $.ajax({
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
                        url: "../StudentManagement/student-fee-info.aspx/CheckActionPermission",
                        data: "{}",
                        dataType: "json",
                        success: function (data) {
                            if (data.d > 0) {
                                err = 10;
                                alertify.error("You have not permission to Partial Payment ! Please Pay FullP Payment.");
                                return false;
                            }
                            else {
                                if (err > 0) {
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                if (data.d == '1') {
                                    ...
                                    if ($('#chkprint').attr('checked') == 'checked') {
                                        window.open("DoublePay.aspx?sid=B-" + myData.ASAID, '_blank');
                                    }
                                }
                                if (data.d == '2') {
            ...
            $('#sname,#txtadmissionno,#txtfromdate,#Text1').change(function () {
                FillFeild()
                BindAdmissionList();
            })
        ...
        function BindAdmissionList() {
            ...
            $.ajax({
                ...
                data: "{'pageno':'" + pageno + "','pagesize':'" + pagesize + "','name':'" + name + "','admission':'" + admission + "','fyid':'" + fyid + "','classid':'" + classid + "','SectionID':'" + sectionID + "','duefromdate':'" + duefromdate + "','duetodate':'" + duetodate + "'}",
                dataType: "json",
                async: false,
                success: function (data) {
                    ...
                    TableGeneralDetails.each(function () {
                        ...
                        trforappend = trforappend + '<tr class=' + Class + '>'
                          ...
                          + '<td>' + CurrentDeailsRow.find("Section").text() + '</td>'
