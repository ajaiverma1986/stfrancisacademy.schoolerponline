<%@ Page Title="" Language="C#" MasterPageFile="~/BranchPanel/MasterPage.master" AutoEventWireup="true" CodeFile="HostelFeeDue.aspx.cs" Inherits="BranchPanel_Fee_Management_HostelFeeDue" %>
    ...
    <div class="branch-div-tbl">
        <div class="content_pane_cont input_content" id="contentPane">
            <div class="tbl-top-heading">
                ...
                <div class="upload" runat="server" visible="false">
                    <i class="fa fa-cloud-download icon"><b class="bg-info"></b></i>
                    ...
                    <div class="divforbindgrid">
                        <table class="stm m-t-sm" style="width: 100%;" cellpadding="0" cellspacing="0">
                            <tr class="stm_head" align="center">
                                ...
                                <th align="center" scope="col">Month</th>
    ...
    <script type="text/javascript">
        ...
        function BindSection() {
            ...
            $.ajax({
                ...
                url: "HostelFeeDue.aspx/BindSectionMethod",
        ...
        function BindGridAfterSearch() {
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "HostelFeeDue.aspx/BindGridOfOverDueList",
                        ...
                        for (var i = 0; i < data.d.length; i++) {
                            if (i % 2 != 0)
                                trforappend = '<tr class="stm_light"><td>' + data.d[i].Rownumber + '</td>' +
                                    ...
                                    //'<td><img class="commentimg" src="../../images/comment.png" style="width:25px;cursor:pointer" /></td>
