                ...
                <%--<table style="width: 75%">
                    ...
                    <tr>
                        ...
                        <td style="width:60%; text-align:center">
                            <span style="font-size: 20px; text-align: center; font-family: Arial; color: #424546; font-weight: 600;"><span runat="server" id="schoolName2"></span></span>
   ...
   <dt style"clear:both;"></dt>
                   ...
                   <td style="visibility:hidden" style="width:50%">
                    ...
                    <tr>
                        ...
                        <td style="width:60%; text-align:center">
                            <span style="font-size: 20px; text-align: center; font-family: Arial; color: #424546; font-weight: 600;"><span id="SchoolName" runat="server"></span></span>
                        ...
                        <td style="width:25%">
                           ...
                           <table style="width: 100%; text-align:center">
                               ...
                               <tr>
                                   <td colspan="3">
                                       <span style="float: right; margin: 0px; font-size: 14px; font-style: italic; font-family: Arial; color: #424546;">Fee Month : <span id="Span40" runat="server" style="font-weight: 600;"></span></span>
                                   </td>
                               </tr>
                           </table>
           <div style="clear:both;"></div>
