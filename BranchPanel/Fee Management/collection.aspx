...
<input type="hidden" value="" id="hdnFile"/>
           ...
           <div class="searchbar containerHeadline" id="GridBatch">
            ...
            <table class="stm" width="100%" cellpadding="0" cellspacing="0">
                <tr class="stm_head" align="center">
                    ...
                    <th align="center" scope="col">Student's Name</th>
                    <th align="center" scope="col">Class</th>
                    <th align="center" scope="col">Father Name</th>
                     <th align="center" scope="col">Payment Mode</th>
                    <th align="center" scope="col">Fee Paid ₹</th>
                    <th align="center" scope="col">consession/discount</th>
        ...
        <script type="text/javascript">
            var year = 2020;
            var fromdate = "", todate = "", name = "",Total=0, TotalFeePaid=0,Fyid=1, TotalServiceTax=0, PaidTaxAmount=0, mobileno = '', receiptno = "", pagesize = 500, pageno = 1, pagecount = 1, paymentmode = 0;
           ...
           function download_file(fileURL, fileName) {
            ...
            function BindGrid() {
                ...
                $.ajax({
                    ...
                    data: "{'fromdate':'" + fromdate + "','todate':'" + todate + "','name':'" + name + "','receiptno':'" + receiptno + "','mobileno':'" + mobileno + "','paymentmode':'" + paymentmode + "','Fyid':'" + $('#ctl00_ContentPlaceHolder1_ddlfyear').val() + "','pagesize':'" + pagesize + "','pageno':'" + pageno + "','userc':'" + user + "'}",
                    dataType: "json",
