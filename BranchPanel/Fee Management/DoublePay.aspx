                ...
                <%--<table style="width: 100%">
                    <tr>
                        <td style="width:100%">
                            ...
                            <div class="receiptwrapper_add" style="font-size: 12px; font-family: Arial; color: #656d70;">
                                <p id="inscontact" runat="server" style="padding: 0px; margin: 2px 0;">Mob.: 
                    ...
                    <tr>
                       ...
                       <table style="width:100%">
                           <tr>
                               <td>
                                   <span style="float: left; font-size: 13px; font-style: italic; font-family: Arial; color: #424546;">Receipt No: <span id="recieptno" runat="server" style="font-weight: bold;"></span></span>
                               </td>
                               <td>
                                   <div style="text-align: center; font-weight: 600;font-size: 14.8px; font-family: Arial; color: #656d70;">Payment Receipt-<span id="spSession1" runat="server" style="font-weight: 600;"></span>(Student Copy)</div>
                               </td>
                               <td>
                           ...
                           <tr>
                               <td colspan="3">
                                   <span style="float: right; font-size: 13px; font-style: italic; font-family: Arial; color: #424546;">Fee Month : <span id="Span24" runat="server" style="font-weight: 600;"></span></span></td>
                           </tr>
                       </table>
...
<%--                 <p style="font-size:14px; float:left; font-family:Arial; color:#424546; width:80px; margin:4px 0 10px;">Profile No . </p>
  ...
  <p style="font-size:14px; float:left; font-family:Arial; color:#424546; width:45px; margin:1px 0 5px;">Adm.ID : </p>
  <dl style="float: left;
    font-size: 13px;
    font-family: Arial;
    color: #424546;
    ...
    font-weight: 600;
    border-bottom: 1px dotted #5f6162;
    width: 15%;"><span id="Span36" runat="server" >N/A</span>&nbsp;</dl>
	 <p runat="server" visible=false style="font-size:14px; float:left; font-family:Arial; color:#424546; width:45px; margin:3px 0 10px;">Mob: </p>
  <dl runat="server" visible=false style="float: left;
    font-size: 13px;
    font-family: Arial;
    color: #424546;
    margin: 1px 0 5px;
    font-weight: 600;
    border-bottom: 1px dotted #5f6162;
    width: 15%;"><span id="Span37" runat="server" ></span>&nbsp;</dl>
                <br />
 ...
 HeaderStyle-CssClass="header" RowStyle-CssClass="rows">
  ...
  <div style="clear:both;"></div>
    ...
    <p style="float:left; font-size:14px; font-style:italic; font-family:Arial; margin-right:4px; margin-top:10px; color:#424546;">Cashier Signatory:</p>
                   ...
                   <td style="width:45%">
                    ...
                    <tr>
                        <td style="width:100%">
                            ...
                            <div class="receiptwrapper_add" style="font-size: 12px; font-family: Arial; color: #656d70;">
                                <p id="P2" runat="server" style="padding: 0px; margin: 2px 0;">Mob.: 
                    ...
                    <tr>
                        ...
                        <td style="width:25%">
                           ...
                           <table style="width: 100%; text-align:center">
                               <tr>
                                   <td><span style="float: left; margin: 0px 0 8px; font-size: 13px; font-style: italic; font-family: Arial; color: #424546;">Receipt No: <span id="recieptno2" runat="server" style="font-weight: bold;"></span></span></td>
                                   <td><span style="text-align: center; font-size: 14.8px; font-weight: 600; font-family: Arial; color: #656d70;">Payment Receipt-<span id="spSession" runat="server" style="font-weight: 600;"></span>(School Copy)</span></td>
                                   <td><span style="float: right; margin: 0px; font-size: 13px; font-style: italic; font-family: Arial; color: #424546;">Date: <span id="recieptdate2" runat="server" style="font-weight: 600;"></span></span></td>
                               </tr>
                               <tr>
                                   <td colspan="3">
                                       <span style="float: right; margin: 0px; font-size: 13px; font-style: italic; font-family: Arial; color: #424546;">Fee Month : <span id="Span40" runat="server" style="font-weight: 600;"></span></span>
                                   </td>
                               </tr>
                           </table>
           <div style="clear:both;"></div>
 ...
 <table style="width:100%">
  ...
  <p style="font-size:14px; float:left; font-family:Arial; color:#424546; width:55px; margin:1px 0 5px;">Adm. ID : </p>
  <dl style="float: left;
    font-size: 13px;
    font-family: Arial;
    color: #424546;
    ...
    font-weight: 600;
    border-bottom: 1px dotted #5f6162;
    width: 15%;"><span id="Span47" runat="server" >N/A</span>&nbsp;</dl>
	<p runat="server" visible=false style="font-size:14px; float:left; font-family:Arial; color:#424546; width:45px; margin:1px 0 5px;">Mob : </p>
  <dl runat="server" visible=false style="float: left;
    font-size: 13px;
    font-family: Arial;
    color: #424546;
    ...
    font-weight: 600;
    border-bottom: 1px dotted #5f6162;
    width: 15%;"><span id="Span400" runat="server" ></span>&nbsp;</dl>
                <br />
