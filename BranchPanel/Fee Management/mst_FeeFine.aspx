    ...
    <div class="content_pane_cont input_content branch-div-tbl" id="FIELDSET1" runat="server">
        ...
        <div id="divall" runat="server">
            <div class="for_sigle_row_form">
                ...
                <asp:TextBox ID="txtFeeName" Text="Late Fee" onkeypress="return lettersOnly(event)" runat="server" placeholder="Enter Fee Name Please."></asp:TextBox>
            </div>
             <div class="for_sigle_row_form">
                <label>
                    Fee Assign To<span style="color: Red;">* </span>
                </label>
                <asp:DropDownList ID="ddlFeeToType" runat="server" AppendDataBoundItems="True"> 
                    <asp:ListItem Value="0" Text="--Select--"></asp:ListItem>              
                    <asp:ListItem Value="1" Text="Monthly"></asp:ListItem>         
                    <asp:ListItem Value="2" Text="Hostel"></asp:ListItem>              
                </asp:DropDownList>&nbsp;
            </div>
            <div class="for_sigle_row_form">
                <label>
            ...
            <tr>
                <td>
                    ...
                    <asp:GridView ID="griview_LateFee" runat="server" EmptyDataText="No data found !" BorderWidth="0" GridLines="None" CssClass="stm" HeaderStyle-Height="30px"
                        AutoGenerateColumns="false" PagerSettings-Position="Bottom" AllowPaging="true" OnRowDeleting="griview_LateFee_RowDeleting"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Fine Type" ItemStyle-HorizontalAlign="Center">
                             ...
                             <asp:TemplateField HeaderText="Fee AssignTo" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                    <asp:Label ID="lblFeeAssignTo" runat="server" Text='<% #Bind("FeeAssignTo")%>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Edit" ItemStyle-HorizontalAlign="Center">
                             ...
                             <asp:TemplateField HeaderText="Edit" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                    <asp:ImageButton ID="imgdelete" runat="server" CommandName="delete" Width="20px" CommandArgument='<%# Eval("FeeID") %>'
                                        ImageUrl="~/images/delete.png" CausesValidation="false" ToolTip="update" />
                                    <asp:HiddenField ID="lblBrid" runat="server" Value='<% #Bind("Brid")%>'></asp:HiddenField>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
