<%@ Page Title="" Language="C#" MasterPageFile="~/BranchPanel/MasterPage.master" AutoEventWireup="true" CodeFile="OnlineFeeCollection.aspx.cs" Inherits="BranchPanel_Fee_Management_OnlineFeeCollection" %>
         ...
         <div class="tbl-top-heading"><h2>Collection List </h2>
              <div class="upload">
                ...
                ToolTip="Click here to download Excel sheet"  ClientIDMode="Static"/>  
                 ...
                 <div class="upload">
                    <i class="fa fa-cloud-download icon"><b class="bg-info"></b></i> <asp:Button ID="IDCAPUCHIN" runat="server"  Visible="true" Text="DCAPUCHIN ACCOUNT"
                CausesValidation="false" Height="20px" CssClass="BtnExcel"
                ToolTip="Click here to CAPUCHIN ACCOUNT"  ClientIDMode="Static"/>  
                      </div>
					   </div>
                 <div class="upload">
                    <i class="fa fa-cloud-download icon"><b class="bg-info"></b></i> <asp:Button ID="IDFRANCIS" runat="server"  Visible="true" Text="ST FRANCIS ACCOUNT"
                CausesValidation="false" Height="20px" CssClass="BtnExcel"
                ToolTip="Click here to CAPUCHIN ACCOUNT"  ClientIDMode="Static"/>  
                      </div>
...
<input type="hidden" value="" id="hdnFile"/>
        <div class="clear"></div>
           ...
           <div class="searchbar containerHeadline" id="GridBatch">
               ...
               <asp:DropDownList runat="server" ID="ddlkPayment" Width="128px" Height="31px">
                   ...
                   <asp:ListItem Value="6" Selected="True">Online</asp:ListItem>
               </asp:DropDownList>
                <asp:DropDownList ID="ddlfyear" runat="server" Width="105px" Height="31px">     
            </asp:DropDownList>
                <asp:DropDownList ID="ddluser" runat="server" Width="105px" Height="31px">     
            </asp:DropDownList>
            ...
            <table class="stm" width="100%" cellpadding="0" cellspacing="0">
                <tr class="stm_head" align="center">
                    ...
                    <th align="center" scope="col">TransactionID</th>
                    <th align="center" scope="col">Account</th>
                    <th align="center" scope="col">Payment Detail</th>
                </tr>
            </table>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                $("#ctl00_ContentPlaceHolder1_ddlkPayment").val("6");
                BindGrid();
                $(".lblpage").html(1);
                ...
                $("#ctl00_ContentPlaceHolder1_ddlkPayment,#ctl00_ContentPlaceHolder1_ddlfyear,#ctl00_ContentPlaceHolder1_ddluser").on('change', function () {
                ...
                $("#btnPdf").click(function (e) {
                    ...
                    alertify.confirm("Are You Sure You Want To Download The Pdf.", function (e) {
                        if (e) {
                            //  window.open($('#hdnFile').val());
                            // window.open('data:application/pdf,' + encodeURIComponent($('#hdnFile').val()));
                            // window.location = $('#hdnFile').val();
                            // window.open($('#hdnFile').val(), "_blank");
            ...
            function FillField() {
                ...
                user = $('#ctl00_ContentPlaceHolder1_ddluser').val();
            }
            ...
            function ClearField() {
                ...
                $('#ctl00_ContentPlaceHolder1_ddluser').val('0');
            ...
            function BindGrid() {
                ...
                $.ajax({
                    ...
                    url: "OnlineFeeCollection.aspx/BindGridByJs",
                    data: "{'fromdate':'" + fromdate + "','todate':'" + todate + "','name':'" + name + "','receiptno':'" + receiptno + "','mobileno':'" + mobileno + "','paymentmode':'6','Fyid':'" + $('#ctl00_ContentPlaceHolder1_ddlfyear').val() + "','pagesize':'" + pagesize + "','pageno':'" + pageno + "','userc':'" + user + "'}",
                    dataType: "json",
                        ...
                        if (data.d.length > 0) {
                            ...
                            for (var i = 0; i < data.d.length; i++) {
                                trforappend = trforappend + "<tr class='stm_light'>" +
                                    ...
                                    "<td>" + data.d[i].TransStatus + " </td>" +
                                    "<td>" + data.d[i].bank_trans + " </td>" +
                                    "<td>" + data.d[i].Bank_Detail + " </td>" +
                                    "<td>" + data.d[i].bank_Name + " </td>" +
                                    "</tr>"
                            }
                            ...
                            //    }
                            $('#SumOfFee').text(parseFloat(data.d[0].TtlPaidAmountWithOutTax).toFixed(2));
                            $('#SumOfTax').text(parseFloat(data.d[0].TtlPaidTaxAmount).toFixed(2));
                            $('#SumOfTotalFee').text(parseFloat(data.d[0].TtlTotal).toFixed(2));
                        }
                        else {
                            $('.GridSum').hide();
