<%@ Page Title="" Language="C#" MasterPageFile="~/BranchPanel/MasterPage.master" AutoEventWireup="true" CodeFile="TransFeeCollection.aspx.cs" Inherits="BranchPanel_Fee_Management_TransFeeCollection" %>
     ...
     <div class="branch-div-tbl">
        ...
        <div class="clear"></div>
           ...
           <div class="searchbar containerHeadline" id="GridBatch">
               ...
               <asp:DropDownList runat="server" ID="ddlkPayment" Width="128px" Height="31px" Visible="false">
        ...
        <script type="text/javascript">
            var year = 2020;
            var fromdate = "", todate = "", name = "", Total = 0, TotalFeePaid = 0, Fyid = 1, TotalServiceTax = 0, PaidTaxAmount = 0, mobileno = '', receiptno = "", pagesize = 200, pageno = 1, pagecount = 1, paymentmode = 0;
            ...
            function BindGrid() {
                ...
                $.ajax({
                    ...
                    url: "TransFeeCollection.aspx/BindGridByJs",
