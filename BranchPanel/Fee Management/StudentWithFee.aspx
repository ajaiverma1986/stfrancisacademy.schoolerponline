<%@ Page Title="" Language="C#" MasterPageFile="~/BranchPanel/MasterPage.master" AutoEventWireup="true" CodeFile="StudentWithFee.aspx.cs" Inherits="BranchPanel_Fee_Management_StudentWithFee" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1"  runat="Server">
    ...
    <script>   
        ...
        $.ajax({
           type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "StudentWithFee.aspx/BindGrid",
                ...
                success: function (data) {
                    ...
                    for (var i = 0; i < data.d.length; i++) {
                         var tr = '<tr><td>' + sn.toString() + '</td><td>' + data.d[i].Sturegno + '</td><td>' + data.d[i].classes + '</td><td>' + data.d[i].section + '</td><td>' + data.d[i].Name + '</td><td>' + data.d[i].Amount + '</td>';
                    ...
                    <div class="divforbindgrid">
                        <table class="stm m-t-sm" style="width: 100%;" cellpadding="0" cellspacing="0" id="tblEmp">
                            <thead>
                                ...
                                <th align="center" scope="col">Fee</th>
