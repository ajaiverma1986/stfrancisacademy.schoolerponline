<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SummerTaining_History.aspx.cs" Inherits="BranchPanel_Fee_Management_SummerTaining_History" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <br />
                ...
                <table style="width: 100%">
                    <tr>
					 <td style="text-align: left; border: none;width:86%" colspan="1">
                                         <img id="grdSTDResult_ctl02_Image1" class="schoollogo" src="../images/home-banner.jpg" style="height:160px;width:100%;border-width:0px;">
                                    </td>
           ...
           <h3 style=" text-align:center; font-size:16px; margin:10px 0 0;  font-family:Arial; color:#656d70;">Receipt 2023-24 TC/Miscellaneous Fee</h3><br>
  ...
  <%--<h6 style=" text-align:center; font-size:16px; margin:10px 0 0;  font-family:Arial; color:#656d70;">(Use Capital Letter Only)</h6>
           ...
           <div style="clear:both;"></div>--%>
               ...
               <div style="clear: both;"></div>
               <p style="font-size: 14px; float: left; font-family: Arial; color: #424546; width: 100%; margin: 3px 0 10px; font-weight: 900; text-align: left;">
                   <b></b>&nbsp;Student Information
               </p>

  <div style="clear:both;"></div>

  <p style="font-size:16px; float:left; font-family:Arial; color:#424546; width:120px; margin:10px 0 10px;"><b></b>&nbsp;Pupil's name</p>
  <dl style="float:left; font-size:13px;  font-family:Arial; color:#424546; font-weight:600;  margin:10px 1% 10px 0px; border-bottom:1px dotted #5f6162; width:81%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span id="recipetrecivername" runat="server"></span></dl>
<%--<asp:Image ID="imguser" runat="server" ImageUrl="~/images/9update.png" Width="120px" Height="120px" />--%>

                   <div style="clear:both;"></div>
      <p style="font-size:14px; float:left; font-family:Arial; color:#424546; width:50px; margin:11px 0 10px;">&nbsp;Class</p>
  <dl style="float:left; font-size:13px;  font-family:Arial; color:#424546; font-weight:600;  margin:11px 1% 10px 0px; border-bottom:1px dotted #5f6162;  width:37%;"><span id="Span3" runat="server" ></span></dl>
 
                  <p style="font-size:14px; float:left; font-family:Arial; color:#424546; width:70px; margin:15px 0 10px; margin-left: 22px;">Gender </p>
                <dl style="float:left; font-size:13px;  font-family:Arial; color:#424546; font-weight:600;  margin:13px 1% 10px 0px; border-bottom:1px dotted #5f6162;  width:40%;">
    ...
    <div style="clear:both;"></div>
               ...
               <%-- mkg start--%>
                <p style="font-size:14px; float:left; font-family:Arial; color:#424546; width:110px; margin:3px 0 10px;"><b></b>&nbsp;Date Of Birth:</p>
     ...
     <div style="clear:both;"></div>
                <p style="font-size:14px; float:left; font-family:Arial; color:#424546; width:135px; margin:3px 0 10px;">&nbsp;Parent Name:</p>
                <dl style="float:left; font-size:13px;  font-family:Arial; color:#424546; margin:4px -35px 0px; font-weight:600;  border-bottom:1px dotted #5f6162; width:35%;">
                    <span id="ParentName" runat="server" ></span>
                </dl>

                <p style="font-size:14px; float:left; font-family:Arial; color:#424546; width:125px; margin:3px 0 10px; margin-left: 55px;">Parent Mobile No :</p>
                <dl style="float:left; font-size:13px;  font-family:Arial; color:#424546; font-weight:600;  margin:3px 1% 25px 0px; border-bottom:1px dotted #5f6162;  width:28%;">
                    <span id="ParentMobileNo" runat="server" ></span>
                </dl>
 
                <div style="clear:both;"></div>
                <p style="font-size:14px; float:left; font-family:Arial; color:#424546; width:150px; margin:-10px 0 10px;">&nbsp;Parent Address:</p>
                <dl style="float:left; font-size:13px;  font-family:Arial; color:#424546; margin:-10px -35px 0px; font-weight:600;  border-bottom:1px dotted #5f6162; width:81%;">
                    <span id="Address" runat="server" ></span>
                </dl>

     <div style="clear:both;"></div>
                <p style="font-size:14px; float:left; font-family:Arial; color:#424546; width:90px; margin:3px 0 10px;">&nbsp;City:</p>
                <dl style="float:left; font-size:13px;  font-family:Arial; color:#424546; margin:4px -50px 0px; font-weight:600;  border-bottom:1px dotted #5f6162; width:35%;">
                ...
                <dl style="float:left; font-size:13px;  font-family:Arial; color:#424546; font-weight:600;  margin:4px 1% 10px -12px; border-bottom:1px dotted #5f6162;  width:30%;">
                 ...
                 <dl style="float:left; font-size:13px;  font-family:Arial; color:#424546; margin:4px -75px 10px; font-weight:600;  border-bottom:1px dotted #5f6162; width:16%;">
                     <span id="Pin" runat="server" ></span>
                 </dl>
                <div style="clear:both;"></div>

                <p style="font-size:14px; float:left; font-family:Arial; color:#424546; width:106px; margin:3px 0 10px;">&nbsp;Country:</p>
               ...
               <div runat="server" id="divEmergency">
                   <br />
                   <p style="font-size: 14px; float: left; font-family: Arial; color: #424546; width: 100%; margin: 3px 0 10px; font-weight: 900; text-align: left;">
                       <b></b>&nbsp;Emergency Contact Person (OTHER THAN PARENTS)
                   </p>

                   <p style="font-size: 14px; float: left; font-family: Arial; color: #424546; width: 100px; margin: 3px 0 10px;">&nbsp;Name :</p>
                   <dl style="float: left; font-size: 13px; font-family: Arial; color: #424546; margin: 4px -35px 0px; font-weight: 600; border-bottom: 1px dotted #5f6162; width: 45%;">
                       <span id="PersonName" runat="server"></span>
                   </dl>

                   <p style="font-size: 14px; float: left; font-family: Arial; color: #424546; width: 85px; margin: 3px 0 10px; margin-left: 55px;">Mobile No :</p>
                   <dl style="float: left; font-size: 13px; font-family: Arial; color: #424546; font-weight: 600; margin: 3px 1% 25px 0px; border-bottom: 1px dotted #5f6162; width: 28%;">
                       <span id="PersonMobile" runat="server"></span>
                   </dl>

                   <p style="font-size: 14px; float: left; font-family: Arial; color: #424546; width: 180px; margin: -10px 0 10px;">&nbsp;Alternate Mobile No :</p>
                   <dl style="float: left; font-size: 13px; font-family: Arial; color: #424546; margin: -10px -35px 0px; font-weight: 600; border-bottom: 1px dotted #5f6162; width: 25%;">
                       <span id="PersonAltMobile" runat="server"></span>
                   </dl>

                   <p style="font-size: 14px; float: left; font-family: Arial; color: #424546; width: 80px; margin: -10px 0 10px; margin-left: 55px;">Phone No :</p>
                   <dl style="float: left; font-size: 13px; font-family: Arial; color: #424546; font-weight: 600; margin: -10px 1% 25px 0px; border-bottom: 1px dotted #5f6162; width: 38%;">
                       <span id="PersonPhone" runat="server"></span>
                   </dl>

                   <br />
                   <br />

                   <p style="font-size: 14px; float: left; font-family: Arial; color: #424546; width: 105px; margin: -10px 0 10px;">&nbsp;Address :</p>
                   <dl style="float: left; font-size: 13px; font-family: Arial; color: #424546; margin: -10px -35px 0px; font-weight: 600; border-bottom: 1px dotted #5f6162; width: 86%;">
                       <span id="PersonAddress" runat="server"></span>
                   </dl>

                   <div style="clear: both;"></div>
                   <p style="font-size: 14px; float: left; font-family: Arial; color: #424546; width: 90px; margin: 3px 0 10px;">&nbsp;City :</p>
                   <dl style="float: left; font-size: 13px; font-family: Arial; color: #424546; margin: 4px -50px 0px; font-weight: 600; border-bottom: 1px dotted #5f6162; width: 35%;">
                       <span id="PersonCity" runat="server"></span>
                   </dl>

                   <p style="font-size: 14px; float: left; font-family: Arial; color: #424546; width: 60px; margin: 3px 0 10px; margin-left: 38px;">State :</p>
                   <dl style="float: left; font-size: 13px; font-family: Arial; color: #424546; font-weight: 600; margin: 4px 1% 10px -12px; border-bottom: 1px dotted #5f6162; width: 30%;">
                       <span id="PersonState" runat="server"></span>
                   </dl>
                   ...
                   <dl style="float: left; font-size: 13px; font-family: Arial; color: #424546; margin: 4px -75px 10px; font-weight: 600; border-bottom: 1px dotted #5f6162; width: 15%;">
                       <span id="PersonPin" runat="server"></span>
                   </dl>
                   <div style="clear: both;"></div>

                   <p style="font-size: 14px; float: left; font-family: Arial; color: #424546; width: 106px; margin: 3px 0 10px;">
                       &nbsp;Country:
                   </p>
                   <dl style="float: left; font-size: 13px; font-family: Arial; color: #424546; margin: 4px -42px 10px; font-weight: 600; border-bottom: 1px dotted #5f6162; width: 24.9%;">
                       <span id="PersonCountry" runat="server"></span>
                   </dl>
               </div>
     ...
     <div style="clear:both;"></div>
               ...
               <p style="font-size: 14px; float: left; font-family: Arial; color: #424546; width: 100px; margin: 11px 0 10px;">&nbsp;Paid Amount :</p>
               <dl style="float: left; font-size: 13px; font-family: Arial; color: #424546; font-weight: 600; margin: 11px 1% 10px 0px; border-bottom: 1px dotted #5f6162; width: 13%;">
                   <span id="PaidFee" runat="server"></span>
               </dl>

               <p style="font-size: 14px; float: left; font-family: Arial; color: #424546; width: 112px; margin: 11px 0 10px;">&nbsp;Payment Mode :</p>
               <dl style="float: left; font-size: 13px; font-family: Arial; color: #424546; font-weight: 600; margin: 11px 1% 10px 0px; border-bottom: 1px dotted #5f6162; width: 14%;">
                   <span id="PaymentMode" runat="server"></span>
               </dl>
 
                  <p style="font-size:14px; float:left; font-family:Arial; color:#424546; width:130px; margin:15px 0 10px;">Registration Date :</p>
                <dl style="float:left; font-size:13px;  font-family:Arial; color:#424546; font-weight:600;  margin:13px 1% 10px 0px; border-bottom:1px dotted #5f6162;  width:20%;">
                    <span id="RegDate" runat="server" ></span>
                </dl>
                 <div style="clear:both;"></div>
                <div runat="server" id="divCheque">
                  <p style="font-size:14px; float:left; font-family:Arial; color:#424546; width:130px; margin:0 0 10px;">&nbsp;Bank Name :</p>
                <dl style="float:left; font-size:13px;  font-family:Arial; color:#424546; margin:0 -35px 0px; font-weight:600;  border-bottom:1px dotted #5f6162; width:82%;">
                    <span id="BankName" runat="server" >s</span>
                </dl>

               <div style="clear:both;"></div>

                <p style="font-size:14px; float:left; font-family:Arial; color:#424546; width:100px; margin:2px 0 10px;">&nbsp;Branch Name :</p>
                <dl style="float:left; font-size:13px;  font-family:Arial; color:#424546; font-weight:600;  margin:2px 1% 25px 0px; border-bottom:1px dotted #5f6162;  width:82%;">
                    <span id="BranchName" runat="server" >s</span>
                </dl>

                   <p style="font-size:14px; float:left; font-family:Arial; color:#424546; width:160px; margin:-10px 0 10px;">&nbsp;Cheque Number :</p>
                <dl style="float:left; font-size:13px;  font-family:Arial; color:#424546; margin:-10px -35px 0px; font-weight:600;  border-bottom:1px dotted #5f6162; width:25%;">
                    <span id="ChequeNo" runat="server" >s</span>
                </dl>

                <p style="font-size:14px; float:left; font-family:Arial; color:#424546; width:100px; margin:-10px 0 10px; margin-left: 55px;">Cheque Date :</p>
                <dl style="float:left; font-size:13px;  font-family:Arial; color:#424546; font-weight:600;  margin:-10px 1% 25px 0px; border-bottom:1px dotted #5f6162;  width:38%;">
                    <span id="ChequeDate" runat="server" >s</span>
                </dl>
               </div>
     ...
     <%--           <p style="                        font-size: 14px;
                        ...
                        color: #424546;
                        width: 220px;
                        margin: 10px 0 10px;"><b>4.  </b>Father Name </p>
