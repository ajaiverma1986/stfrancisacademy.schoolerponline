<%@ Page Title="" Language="C#" MasterPageFile="~/BranchPanel/MasterPage.master" AutoEventWireup="true" CodeFile="overdue-Monthwise.aspx.cs" Inherits="BranchPanel_Fee_Management_overdue_Monthwise" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
   ...
   style = document.createElement('style');
            ...
            <div class="tbl-top-heading">
                ...
                <div class="upload">
                    ...
                    <asp:Button ID="Button1" runat="server" Text="Month Wise Report" Visible="true"
                        CausesValidation="false" Height="20px" CssClass="BtnExcel" PostBackUrl="~/BranchPanel/Fee Management/overdue-Monthwise.aspx" Style="float: right;"
                        ToolTip="Click here to download Excel sheet" />
                </div>
            </div>
            ...
            <div class="grid-data-resposive">
                ...
                <div class="divTableDataHolder m-l-sm m-r-sm">
                    <div class="divforbindgrid" >
                        <table class="stm m-t-sm" style="width: 97%;" cellpadding="0" cellspacing="0">
                            <tr class="stm_head" align="center">
                                <th align="center" scope="col">S.No.</th>
                                <th align="center" scope="col">Reg No</th>
                                <th align="center" style="width:12%;" scope="col">Name</th>
                                <th align="center" scope="col">Class</th>
                                <th align="center" scope="col">Section</th>
                                <th align="center" style="width:15%;" scope="col">Payable/Overdue Amount</th>
                                <th align="center" scope="col">Tax</th>
                                <th align="center" scope="col">Due Months</th>
                                <th align="center" scope="col">Total Due</th>
                                <th align="center" scope="col" style="width:15%;">Mobile</th>        
    ...
    <script type="text/javascript">
        var Fyid = 0, pagesize = 4000, pageno = 1, sectionID = 0, trindexforpay = 0, pagecount = 0, stuname = '', duefromdate = '', duetodate = '', mobileno = '', classid = 0, year = 2050;
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.d.length > 0) {
                        ...
                        var MonthAlll = '';
                        if ($('#txtduedatefrom').val() == '' && $('#txtduedateto').val() == '') {
                            MonthAlll = '01 April - 1 March';
                        }
                        else {
                            MonthAlll = $('#txtduedatefrom').val() + '-' + $('#txtduedateto').val();
                        }
