...
public partial class BranchPanel_rejected_student_list : System.Web.UI.Page
{
    ...
    private void Fill_Grid()
    {
        ...
        {
            grdforrejectedstudents.DataSource = ds.Tables[0];
            grdforrejectedstudents.DataBind();
            hfpages.Value = ds.Tables[1].Rows[0]["pages"].ToString();
        }
        else
        {
            grdforrejectedstudents.EmptyDataText = "No Record Found";
            grdforrejectedstudents.DataBind();
        }
