<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/BranchPanel/MasterPage.master"
    CodeFile="viewenquiry.aspx.cs" Inherits="BranchPanel_viewenquiry" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script src="../../js/session-0.4.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            var a = $("#ctl00_lbluser").html();
            $("#ctl00_ContentPlaceHolder1_txtcontactedby").val(a);
            ...
            $("#ctl00_ContentPlaceHolder1_txtDate").click(function () {
                $(this).datepicker({
                    changeMonth: true,
                    changeYear: true,
                    dateFormat: 'mm/dd/yy',
            ...
            function sendsms() {
                ...
                $.ajax({
                    ...
                    url: "viewenquiry.aspx/sendsmsonmobile",
        ...
        var ddlsearchbydate = "enquirydate", ddlfromdate = "", ddltodate = "", ddlsearchbyproduct = "", ddlsearchbyenquirysource = "", ddlsearchbystatus = "", ddlsearchby = "", txtsearchtext = "", ddlenquirytype = "viewgrid";
            var startindex = 1, endindex = 100, identifylastpage = "";
            $(document).ready(function () {
                $('#ctl00_ContentPlaceHolder1_ddlstatus').val('0');
                $('.check').change(function () {
                    var enquiryid = $(this).parents("tr").find("input[type=hidden]").val();
                    var answer = confirm('Are You Sure You Want To Send This Enquiry In Archive Enquiry List.?');
                    if (answer == true) {
                        $.ajax({
                            type: "POST",
                            contentType: "application/json; charset=utf-8",
                            url: "../Comman.aspx/SendInArchive",
                            ...
                            error: function (result) {
                                alertify.error("Sorry You Can't Send This Now.");
                            }
                        });
                    }
                    else {
                ...
                $('#ctl00_ContentPlaceHolder1_ddlstatus').change(function () {
                    if ($(this).val() == 7) {
                        $('#divforleadstatus').show(500);
                        $('#divfd').show(500);
                        $('#divft').show(500);
                    }
                    else {
                        $('#divforleadstatus').hide(500);
                        $('#divfd').hide(500);
                        $('#divft').hide(500);
                    }
                });

                var sno = "", enquiryno = "", enquirydate = "", name = "", mobileno = "", product = "", status = "", city = "";
                ...
                function Uploadexcel() {
                    ...
                    $.ajax({
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
                        url: "viewenquiry.aspx/BindDataTableFromExcelSheet",
                        data: "{'sno':'" + sno + "','enquiryno':'" + enquiryno + "','enquirydate':'" + enquirydate + "','name':'" + name + "','mobileno':'" + mobileno + "','product':'" + product + "','status':'" + status + "','city':'" + city + "'}",
                        dataType: "json",
                        success: function (data) {
                            return false;
                        },
                ...
                $("#ctl00_ContentPlaceHolder1_txtfromdateforsearch").on('change', function () {
                ...
                $("#ctl00_ContentPlaceHolder1_txttodateforsearch").on('change', function () {
                    startindex = parseInt(1);
                    endindex = parseInt(startindex) + parseInt(99);
                ...
                $('#ctl00_ContentPlaceHolder1_ddlenquirytype').live('change', function () {

                    startindex = parseInt(1);
                    endindex = parseInt(startindex) + parseInt(99);
                    ddlenquirytype = $.trim(this.value);
                    BindGridAfterSearching();
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.d.length > 0) {
                            ...
                            $("[id*=gridenquiry] tr").not($("[id*=gridenquiry] tr:first-child")).remove();
                            $("[id$=gridenquiry]").append(row);
                            $('#ctl00_ContentPlaceHolder1_gridenquiry').hide(500);
                            $("#ctl00_ContentPlaceHolder1_lblmessage").show(500);
                            call_progressbar("end");
                        }
                        $("[id*=gridenquiry] tr").show();
                        $("[id*=gridenquiry] tr:first-child").show();
            ...
            var enquirydate = '', source = '', sourceid = '', name = '', femail = '', fmobile = '', statustxt = '', statusid = '', leadstatusid = '', leadstatustxt = ''; contactdate = '',
            ...
            function forshow() {
                ...
                $('.gridViewToolTip').click(function () {
                    ...
                    $.ajax({
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
                        url: "viewenquiry.aspx/GetEnquiryDetails",
                        data: "{'eid':'" + eid + "'}",
                        dataType: "json",
                        success: function (data) {
                            for (var i = 0; i < data.d.length; i++) {
                                ...
                                document.getElementById('ctl00_ContentPlaceHolder1_ddleh').value = data.d[i].followuptimeid;
                                ...
                                if (parseInt(data.d[i].status) > 1)
                                    ...
                                    document.getElementById('ctl00_ContentPlaceHolder1_ddlstatus').value = "0";
                            }
                        },
                        error: function (result) {
            ...
            function forceClick() {
                ...
                if ($("#ctl00_ContentPlaceHolder1_ddlstatus").val() != 7) {
                    ...
                    statustxt = document.getElementById("ctl00_ContentPlaceHolder1_ddlLeadStatus").options[document.getElementById("ctl00_ContentPlaceHolder1_ddlLeadStatus").selectedIndex].text
                    statusid = document.getElementById('ctl00_ContentPlaceHolder1_ddlLeadStatus').value;
                    leadstatustxt = document.getElementById("ctl00_ContentPlaceHolder1_ddlLeadStatus").options[document.getElementById("ctl00_ContentPlaceHolder1_ddlLeadStatus").selectedIndex].text
                    leadstatusid = document.getElementById('ctl00_ContentPlaceHolder1_ddlstatus').value;
                }
                ...
                if (statusid == 0) {
                    ...
                    if (leadstatusid == 7) {
                        if (leadstatusid == 0) {
                            alertify.error("Please select Lead status.");
                            return;
                        }
                        else {
                            if (followupdate == "") {
                                ...
                                if (followuptimeid == 0) {
                                    alertify.error("Please select followup time.");
                                    return;
                                }
                                else {
                                    statustxt = leadstatustxt;
                                    document.getElementById("ctl00_ContentPlaceHolder1_Button3").value = "Processing..";
                                    $('#ctl00_ContentPlaceHolder1_Button3').attr("disabled", "true");
                                    updateenquiry();
                                    return;
                                }
                            }
                ...
                function updateenquiry() {
                    ...
                    $.ajax({
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
                        url: "viewenquiry.aspx/UpdateEnquiry",
                        data: "{'enquirydate':'" + enquirydate + "','source':'" + source + "','sourceid':'" + sourceid + "','name':'" + name + "','femail':'" + femail +
                          ...
                          "','email2':'" + email2 + "','email3':'" + email3 + "','mob2':'" + mob2 + "','mob3':'" + mob3 + "','leadstatusid':'" + leadstatusid + "','enquirytypeid':'" + enquirytypeid + "','enquirytypetxt':'" + enquirytypetxt + "','eid':'" + eid + "'}",
                        dataType: "json",
                        success: function (data) {

                            if (data.d == 1) {
                                alertify.success("This record has been updated successfully");
                                document.getElementById("ctl00_ContentPlaceHolder1_Button3").value = "Update";
                                $('#ctl00_ContentPlaceHolder1_Button3').removeAttr('disabled');
                                $('#popupdiv').dialog('close');
                                BindGridAfterSearching();
                                return false;
                            }
    ...
    <asp:HiddenField ID="hfpages" runat="server" />
            ...
            <div id="divformobile" style="text-align: center; display: none;">
                <div style="width: 95%; margin: 10px;">
                    <table class="showpopup2" style="background-color: white; vertical-align: top">
                        <tr>
                            <td colspan="4" style="text-align: right; cursor: pointer; color: red; padding-right: 13px;
                                padding-top: 5px;" id="td2">
            ...
            <div id="popupdiv" class="showpopup" style="text-align: center; margin-left: -145px !important;
                display: none">
                <div style="text-align: right;">
                    <a id="tdClosepopup" style="text-align: right; color: red; cursor: pointer; font-weight: bold;
                        margin-right: 14px; margin-top: 10px !important;">Close</a>
                </div>
                <div id="content">
                    <div id="tab1">
                        <table id="tbl1" class="file_border bkrt" cellpadding="2" cellspacing="0" border="0"
                            style="width: 45%; float: left; background: #F7F7F7; border-radius: 0px; border: 1px solid #8CBF26;
                            float: left; margin: 20px 20px; margin-top: 30px; position: relative; padding-top: 30px;">
                            <tr>
                                <td>
                                    <div class="form-box-heading">
                                        Enquiry Details
                                    </div>
                                    <div style="margin: -8px 200px 5px; font-size: 12pt; font-weight: bold; background-color: #a50505;
                                        width: 200px!important; color: white!important; text-align: center!important;"
                                        class="for_sigle_row_form">
                                        <label style="font-size: 12pt; font-weight: bold; color: white; margin-left: -70px;
                                            margin-top: -2px;">
                                            Enquiry ID:
                                        </label>
                        ...
                        <table id="tbl2" class="file_border bkrt" cellpadding="2" cellspacing="0" border="0"
                            style="width: 45%; float: left; background: #F7F7F7; border-radius: 0px; border: 1px solid #8CBF26;
                            padding-top: 30px; position: relative; margin-top: 30px;">
                            <tr>
                                <td>
                                    <div class="form-box-heading">
                                        Updation Details
                                    ...
                                    <div class="for_sigle_row_form">
                                        ...
                                        <asp:TextBox ID="txtDate" CssClass="Picker" runat="server"></asp:TextBox>&nbsp;
                                    </div>
                                    <div class="for_sigle_row_form">
                                        <label>Time</label>
                                        <asp:DropDownList ID="ddlsh" Width="100px" runat="server"></asp:DropDownList>
                                    </div>
                                    <div class="for_sigle_row_form">
                                        <label>Contacted By<span style="color: Red">*</span></label>
                                        <asp:TextBox ID="txtcontactedby" ReadOnly="true" runat="server"></asp:TextBox>&nbsp;
                                    </div>
                                    <div class="for_sigle_row_form">
                                    ...
                                    <div class="for_sigle_row_form" id="divforleadstatus" style="display: none">
                                        <label> Lead Status<span style="color: Red">*</span></label>
                                        <asp:DropDownList runat="server" ID="ddlLeadStatus">
                                        </asp:DropDownList>
                                    </div>
                                    ...
                                    <div id="divft" class="for_sigle_row_form">
                                        <label>
                                            Followup Time<span style="color: Red">*</span></label>
                                    ...
                                    <div class="for_sigle_row_form">
                                        ...
                                        <a id="gethistory" style="cursor:pointer">click here to see the previous contacted details</a>
                                    </div>
                                    <div class="for_sigle_row_form">
                                        <label>
                                            Remarks
                                    ...
                                    <div class="for_sigle_row_form" style="margin: 0px;">
                                        ...
                                        <asp:Button ID="Button3" runat="server" Text="Update" OnClientClick="forceClick(); "
                                            CssClass="button_save" Style="margin-top: 0px!important; margin-left: 0px!important" />
                                    </div>
                                </td>
                            </tr>
                        </table>
                        <table id="CustomerTable" style="display: none; width: 1197px!important; font-size: 12pt; font-family: Arial;" class="stm" >
                            <tr class="stm_head">
            ...
            <div class="content_pane_cont input_content" id="contentPane">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 0px;
                    box-shadow: 1px 1px 2px 0 rgba(0, 0, 0, 0.3);" class="stm">
                    <tr>
                        <td colspan="10" class="containerHeadline">
                            <div style="float: left; width: 1200px">
                                <asp:TextBox ID="txtfromdateforsearch" runat="server" Width="70px" Height="23px"
                                ...
                                <asp:DropDownList ID="ddlsearchoption" runat="server" Width="133px">
                        ...
                        <tr>
                            <td align="left" colspan="12" style="width: 100%; padding-left: 0px; padding-right: 0px;">
                                <asp:GridView ID="gridenquiry" AutoGenerateColumns="false" EmptyDataText="No data found."
                                    ...
                                    <Columns>
                                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="S.No" HeaderStyle-Width="60px">
                                            <ItemTemplate>
                                                <asp:Label CssClass="sno" ID="lblroeno" Text='<%#Eval("RowNumber") %>' runat="server"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Enquiry No." HeaderStyle-Width="100px">
                                            <ItemTemplate>
                                                <asp:Label CssClass="realenquiryno" ID="lblenquiryno" Text='<%#Eval("real_Enqiry_Id") %>'
                                                    runat="server"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Enquiry Date" HeaderStyle-Width="100px">
                                            <ItemTemplate>
                                                <asp:Label ID="lblenqdate1" CssClass="enqdate" Text='<%#Eval("enquirydate","{0:MMM dd yyyy}") %>'
                                                    runat="server"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Name" HeaderStyle-Width="200px">
                                            <ItemTemplate>
                                                <asp:Label ID="lblname1" CssClass="nameforjquery" Text='<%#Eval("name") %>' runat="server"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Mobile No" HeaderStyle-Width="100px">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lblmob" Text='<%# Eval("mobile") %>' Style="color: black" runat="server"
                                                    CssClass="mobile" ToolTip="click here for send sms."></asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Class" HeaderStyle-Width="100px">
                                            <ItemTemplate>
                                                <asp:Label ID="lblenqdate" CssClass="enqtype" Text='<%#Eval("enqtype") %>' runat="server"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Status" HeaderStyle-Width="150px">
                                            <ItemTemplate>
                                                <asp:Label ID="lblstatus1" CssClass="statusname" Text='<%#Eval("statusname") %>'
                                                    runat="server"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="City" HeaderStyle-Width="100px">
                                            <ItemTemplate>
                                                <asp:Label ID="lblcitytemplate" CssClass="City" Text='<%#Eval("city") %>' runat="server"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Edit" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="80px">
                                            <ItemTemplate>
                                                <dl>
