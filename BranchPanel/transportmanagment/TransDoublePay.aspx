<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TransDoublePay.aspx.cs" Inherits="BranchPanel_transportmanagment_TransDoublePay" %>
                    ...
                    <tr>
                       ...
                       <table style="width:100%">
                           <tr>
                               ...
                               <td>
                                   <div style="text-align: center; font-weight: 600; font-family: Arial; color: #656d70;">Payment Receipt-2024-25(Student Copy)</div>
                               </td>
                               <td>
...
<%--                 <p style="font-size:14px; float:left; font-family:Arial; color:#424546; width:80px; margin:4px 0 10px;">Profile No . </p>
 ...
 <p style="font-size:14px; float:left; font-family:Arial; color:#424546; width:55px; margin:3px 0 10px;">Ref No : </p>
  <dl style="float: left;
    ...
    font-weight: 600;
    border-bottom: 1px dotted #5f6162;
    width: 20%;"><span id="Span36" runat="server" >N/A</span>&nbsp;</dl>

    <p style="font-size:14px; float:left; font-family:Arial; color:#424546; width:55px; margin:3px 0 10px;">Bus No : </p>
  <dl style="float: left;
    font-size: 13px;
    font-family: Arial;
    color: #424546;
    ...
    font-weight: 600;
    border-bottom: 1px dotted #5f6162;
    width: 20%;"><span id="SpBusNo" runat="server" >N/A</span>&nbsp;</dl>
                    ...
                    <tr>
                        <td style="width:100%">
                            ...
                            <asp:Image ID="Image2" runat="server" Width="100px" />
                             <p><b>CAPUCHIN FRIARS MINOR SOCIETY</b></p>   
                           <!-- <dl style="font-size: 20px; height: 8px; text-align: center; font-family: Arial; color: #424546; font-weight: 600;"><span id="schoolName2" runat="server"></span></dl>--!>CAPUCHIN FRIARS MINOR SOCIETY
                        ...
                        <td style="width:25%">
                           ...
                           <table style="width: 100%; text-align:center">
                               <tr>
                                   ...
                                   <td><span style="text-align: center; font-weight: 600; font-family: Arial; color: #656d70;">Payment Receipt-2024-25(School Copy)</span></td>
 ...
 <table style="width:100%">
  ...
  <dl style="float: left;
    ...
    font-weight: 600;
    border-bottom: 1px dotted #5f6162;
    width: 20%;"><span id="SpBusNo1" runat="server" >N/A</span>&nbsp;</dl>
