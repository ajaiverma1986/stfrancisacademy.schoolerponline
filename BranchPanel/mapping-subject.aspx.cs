...
public partial class BranchPanel_mapping_subject : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Session["empid"] == null)
        {
            ...
            {
                facultyID = Convert.ToInt32(Request.QueryString["id"].ToString());
                Session["empid"] = facultyID;
            }
            else
            {
    ...
    {
        String Facultyname = Convert.ToString(objDUT.GetScalar("select fname from tblEmp_Master where eid=" + Session["empid"]));
    ...
    protected void btn_Click1(object sender, EventArgs e)
    {
        ...
        {
            param[0] = new SqlParameter("@facultyID", Convert.ToInt32(Session["empid"]));
        ...
        if (intresult == 1)
        {
            ...
            if (ViewState["facultyid"] != null)
            {
                Response.Redirect("mapping-subject.aspx", true);
            }
            else
            {
            }
