<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BonafideCert.aspx.cs" Inherits="BranchPanel_Certificates_BonafideCert" %>
        ...
        <div class="Main">
            ...
            <div class="middle">
                ...
                <div>
                    ...
                    is a bonafide student of this school studying in class&nbsp<b><asp:Label ID="lblclass" runat="server" Width="220px" Font-Size="20px" Style="border-bottom:dotted 2px black;text-align:center">III</asp:Label></b>His / Her date of
                        <br />
                        <br />
