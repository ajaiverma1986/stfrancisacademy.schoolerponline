...
public partial class BranchPanel_Certificates_BonafideCert : System.Web.UI.Page
{
    ...
    public void Update(int ID)
    {
        ...
        inner join Class_Master CM on cm.id = SR.ApplyingForClass where SM.SturegNo=" + ID + " and SR.Brid=" + Convert.ToInt32(Session["BrBrid"]) + " and IsActive=1";
