...
public partial class BranchPanel_Certificates_ViewTC : System.Web.UI.Page
{
    ...
    {
        BookNo.InnerText = Convert.ToString(dtTC.Rows[0]["BookNo"]);
        OldRegNo.InnerText = Convert.ToString(dtTC.Rows[0]["OldRegNo"]);
        SNo.InnerText = dtTC.Rows[0]["TCNo"].ToString();
        ...
        lblCate.InnerText = dtTC.Rows[0]["Gen"].ToString();
