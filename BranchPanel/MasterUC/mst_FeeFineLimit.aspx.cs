...
public partial class BranchPanel_MasterUC_SetFeeFineLimit : System.Web.UI.Page
{
    private string url;
    private int query;
    ...
    private void fillgrid()
    {
        ...
        string querynew = @"Select FeeID,FeeName,FeeAmt,isActive,Brid,Fyid,FeeAfterDays,CASE WHEN FeeType=1 THEN 'DayWise' ELSE 'Fixed' END FeeType  from mst_Feefine where Brid=" + Session["BrBrid"] + " and fyid = " + fyid + "order by FeeID asc";
        ...
        {
            ScriptManager.RegisterStartupScript(this, this.GetType(), "Message", "alert('Please add Late Fee Limit in the branch.')", true);
            return;
        }
    }
    ...
    protected void griview_LateFee_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "Edit1")
        {
            ...
            string str = "select FeeID,FeeName,isActive,FeeType,FeeAmt,FeeAfterDays from mst_FeeFine where Brid=" + Session["brBrid"] + "and FeeID=" + asd;
