...
public partial class BranchPanel_MasterUC_mst_SetResult : System.Web.UI.Page
{
    ...
    protected void grdBranch_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "c1")
        {
            //Already Define Fyid in Stored Procudure
            ...
            param[2] = new SqlParameter("@Brid", Convert.ToInt32(Session["BrBrid"]));
            ds = objdut.GetDataSetSP(param, "Usp_ResultToClas");
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        param1[1] = new System.Data.SqlClient.SqlParameter("@ResultTypeID", subjectid);
        ...
        int intresult = objdut.ExecuteSqlSP(param1, "addResultinclass");
        if (intresult > 0)
        {
            Utility.ViewAlertMessage(this.Master.Page, "ResultType added successfully in the selected Class.");
            grdsubject.DataSource = null;
            grdsubject.DataBind();
            btnSubmit.Visible = false;
            tr2.Visible = false;
