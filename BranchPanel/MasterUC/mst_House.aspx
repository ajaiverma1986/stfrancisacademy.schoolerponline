<%@ Page Title="" Language="C#" MasterPageFile="~/BranchPanel/MasterPage.master" AutoEventWireup="true" CodeFile="mst_House.aspx.cs" Inherits="BranchPanel_MasterUC_mst_House" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="content_pane_cont input_content branch-div-tbl" id="FIELDSET1" runat="server">
         <div class="tbl-top-heading" style="width: 100%; margin-left: 0px">
            <h2>House Name List</h2>
             <asp:Button runat="server" ID="Button2" CssClass="button_save"  Text="Add House Name" Style="float: right; margin-top: 5px; margin-right: 3px" ToolTip="Click here to Add Section." OnClick="Button2_Click" />
        ...
        <div id="divall" runat="server">
            <div class="for_sigle_row_form">
                <label>
                    House Name<span style="color: Red;">* </span>
                </label>
                <asp:TextBox ID="txthouseName" Text="" onkeypress="return lettersOnly(event)" runat="server" placeholder="Enter House Name Please."></asp:TextBox>
            </div>
            <div class="for_sigle_row_form">
                    ...
                    <asp:GridView ID="griview_LateFee" runat="server" EmptyDataText="No data found !" BorderWidth="0" GridLines="None" CssClass="stm" HeaderStyle-Height="30px"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Edit" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                    <asp:ImageButton ID="imgEdit" runat="server" CommandName="Edit1" CommandArgument='<%# Eval("HouseID") %>'
