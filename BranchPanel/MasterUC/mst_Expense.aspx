<%@ Page Title="" Language="C#" MasterPageFile="~/BranchPanel/MasterPage.master" AutoEventWireup="true" CodeFile="mst_Expense.aspx.cs" Inherits="BranchPanel_MasterUC_ExpenseMS" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="content_pane_cont input_content branch-div-tbl" id="FIELDSET1" runat="server">
         <div class="tbl-top-heading" style="width: 100%; margin-left: 0px">
            <h2>Expense List</h2>
             <asp:Button runat="server" ID="Button2" CssClass="button_save"  Text="Add Expenses Name" Style="float: right; margin-top: 5px; margin-right: 3px" ToolTip="Click here to Add Section." OnClick="Button2_Click" />
        ...
        <div id="divall" runat="server">
            <div class="for_sigle_row_form">
                ...
                <asp:TextBox ID="txtExpName" Text="" onkeypress="return lettersOnly(event)" runat="server" placeholder="Enter Fee Name Please."></asp:TextBox>
            </div>
            <div class="for_sigle_row_form">
                    ...
                    <asp:GridView ID="griview_LateFee" runat="server" EmptyDataText="No data found !" BorderWidth="0" GridLines="None" CssClass="stm" HeaderStyle-Height="30px"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Expense Name" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                    <asp:Label ID="lblproducname" runat="server" Text='<% #Bind("titlename")%>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField> 
