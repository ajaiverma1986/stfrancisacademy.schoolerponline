...
public partial class BranchPanel_Exams_Co_Schoolistic : System.Web.UI.Page
{
    ...
    private void FillGrid(int classid, int sectionid, int Mode)
    {
      ...
      //  {
       ...
       // catch (Exception ex)
       // { 
//Utility.ViewAlertMessage(Page, ex.Message);
//}
    }
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (dtSubjectMark.Rows.Count > 0)
        {
            string FileName = ddlexam.SelectedItem.Text + "_" + ddlcourse.SelectedItem.Text + "_" + ddlsection.SelectedItem.Text + "_Shl_"  + DateTime.Today.ToString("dd_MMM_yy");
            string filepath = "";
            ...
            manageDoc.CreatePdf(filepath, dtSubjectMark, " ");
