        ...
        if (dtExam.Rows.Count > mm)
        {
            ...
            if (dtSubject.Rows.Count > 0)
            {
                ...
                if (dtMarks.Rows.Count > 0)
                {
                    ...
                    for (int a = 0; a < dtMarks.Rows.Count; a++)
                    {
                        ...
                        for (int b = 1; b < dtMarks.Columns.Count; b++)
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    string strMarks = @"Select ISnull(marks,'0') marks,ISNULL(Grade,'') Grade,ISNULL(IsGrade,'0') IsGrade
                                    ...
                                    //string strGrade = "Select ISnull(Grade,'') Grade from tbl_marks_master where sectionid=" + SectionID + " and examid=" + ExamID + " and classid=" + ClassID + " and subjectid=" + SubjectID + " and studentregno=" + eid + "";
                                    //GradeValue = Convert.ToString(ObjDut.GetScalar(strGrade));
                                    //if (string.IsNullOrWhiteSpace(GradeValue))
                                    //{
                                    //    dtMarks.Rows[a][b] = Marks.ToString();
                                    //}
                                    //else {
                                    //    dtMarks.Rows[a][b] = GradeValue.ToString();
                                    //}
                                }
                            }
                        }
                    ...
                    html.Append("<tr>");
                    html.Append("<th style='Width:154px; text-align: center; font-size: 12px;font-weight:bold; line-height: 30px;'>");
                    html.Append("");
                    html.Append("</th>");
