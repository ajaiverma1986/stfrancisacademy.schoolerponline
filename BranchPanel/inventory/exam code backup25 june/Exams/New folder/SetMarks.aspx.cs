...
public partial class BranchPanel_Exams_SetMarks : System.Web.UI.Page
{
    ...
    protected void grdsetmarks_RowDataBound1(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (ddlsubject.SelectedValue != "0")
            {
                string strMarks1 = "Select ISnull(marks,'0') marks from tbl_marks_master where sectionid="+ ddlsection.SelectedValue + " and examid=" + TempDt.Rows[Start1][0] + " and classid=" + ddlcourse.SelectedValue + " and subjectid=" + ddlsubject.SelectedValue + " and studentregno=" + lblregno.Text.ToString() + "";
                ...
                string strMarks2 = "Select ISnull(marks,'0') marks from tbl_marks_master where sectionid=" + ddlsection.SelectedValue + " and examid=" + TempDt.Rows[Start2][0] + " and classid=" + ddlcourse.SelectedValue + " and subjectid=" + ddlsubject.SelectedValue + " and studentregno=" + lblregno.Text.ToString() + "";
                ...
                string strMarks3 = "Select ISnull(marks,'0') marks from tbl_marks_master where sectionid=" + ddlsection.SelectedValue + " and examid=" + TempDt.Rows[Start3][0] + " and classid=" + ddlcourse.SelectedValue + " and subjectid=" + ddlsubject.SelectedValue + " and studentregno=" + lblregno.Text.ToString() + "";
                ...
                string strMarks4 = "Select ISnull(marks,'0') marks from tbl_marks_master where sectionid=" + ddlsection.SelectedValue + " and examid=" + TempDt.Rows[Start4][0] + " and classid=" + ddlcourse.SelectedValue + " and subjectid=" + ddlsubject.SelectedValue + " and studentregno=" + lblregno.Text.ToString() + "";
