                    ...
                    <div class="for_sigle_row_form">
                      ...
                      <div id="for_sigle_row_Download" runat="server" visible="false">
                        <asp:Button ID="btnDwonload" Style="float:right;" runat="server" Text="Download" CssClass="button_save" OnClick="btnDwonload_Click" />&nbsp;&nbsp;&nbsp;
                          <asp:Button ID="Button1" Style="float:right;margin-right:10px;" runat="server" Text="Download PDF" CssClass="button_save" OnClick="Button1_Click" />
                    </div>
                   <div id="Div1" runat="server" class="for_sigle_row_form">
