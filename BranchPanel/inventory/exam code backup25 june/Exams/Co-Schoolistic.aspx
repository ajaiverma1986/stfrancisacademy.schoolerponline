                        ...
                        <div class="divforstm">
                            <asp:GridView ID="grdsetmarks" runat="server" AutoGenerateColumns="false" GridLines="None" Width="100%" BorderWidth="0" CssClass="containerHeadline" OnRowDataBound="grdsetmarks_RowDataBound">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Computer" HeaderStyle-Width="150">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Drawing" HeaderStyle-Width="150">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="GK" HeaderStyle-Width="150">
                                        <ItemTemplate>
