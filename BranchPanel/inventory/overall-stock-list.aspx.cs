...
public partial class BranchPanel_inventory_overall_stock_list : System.Web.UI.Page
{
    ...
    [WebMethod]
    public static string BindStockList(string Category, string SubCategory, string Product, string TillDate)
    {
