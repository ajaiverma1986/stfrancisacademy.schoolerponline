...
public partial class BranchPanel_Fee_Management_overall_admissions : System.Web.UI.Page
{
    ...
    [WebMethod]
    public static GetadmissionDetails[] BindGridByJs(string StudentName, string ParentMobileNo, string AdmissionNo, string FromDate, string ToDate, string ClassId, string pagesize,string pageno, string fyid)
    {
    ...
    [WebMethod]
    public static getlabelsdetails[] Bindlable(string StudentName, string ParentMobileNo, string AdmissionNo, string FromDate, string ToDate, string ClassId, string pagesize,          string pageno, string fyid)
    {
        DataSet Ds = new DataSet();
