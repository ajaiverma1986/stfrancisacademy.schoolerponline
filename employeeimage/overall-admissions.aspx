    ...
    <div class="branch-div-tbl">
        <div class="content_pane_cont input_content" id="contentPane">
            ...
            <script type="text/javascript">
                var year = 2050;
                var pagesize = 100, pageno = 1, pagecount = 1, StudentName = '', ParentMobileNo = '', AdmissionNo = '', FromDate = '', ToDate = '', ClassId = 0, fyid = 0;
                $(document).ready(function () {
                    BindClass();
                    BindGrid();
                    Bindlabels();
                    $('#sname,#parentmob,#txtadmissionno,#ctl00_ContentPlaceHolder1_ddlfinancialyear,#dllclass,#txtfromdate,#txttodate').change(function () {
                        BindGrid();
                        Bindlabels();
                    });
                ...
                function Bindlabels() {
                    ...
                    $.ajax({
                        ...
                        data: "{'StudentName':'" + StudentName + "','ParentMobileNo':'" + ParentMobileNo + "','AdmissionNo':'" + AdmissionNo + "','FromDate':'" + FromDate + "','ToDate':'" + ToDate + "','ClassId':'" + ClassId + "','pagesize':'" + pagesize + "','pageno':'" + pageno + "','fyid':'" + fyid + "'}",
                        dataType: "json",
                        success: function (data) {
                            if (data.d.length > 0) {
