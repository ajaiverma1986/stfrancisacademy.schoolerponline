<%@ Page Title="" Language="C#" MasterPageFile="~/EmployeePanel/employee-panel-master.master" AutoEventWireup="true" CodeFile="requestleave.aspx.cs" Inherits="EmployeePanel_requestleave" %>
                ...
                <div class="main-content">
                    ...
                    <div style="margin-bottom: 60px; margin-top: 15px; width: 100%;" id="div3">
                        <div style="height: 28px; width: 16%; background: #F0953F; float: left; margin-left: .5%; text-align: center; color: white; padding: 5px">
                            Max Paid/Year:<span id="available" style="display:none"></span>
                        </div>
