<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdmitCard.aspx.cs" Inherits="EmployeePanel_AdmitCard" %>
                        ...
                        <div style="width: 730px; height: 100%; border: solid 1px black; padding: 10px 10px 10px 10px; margin-bottom:2px;">
                            <table style="width: 100%; text-align: center; border: none; margin-top: -10px;">
                                ...
                                <tr>
                                    <td style="text-align: left; border: none;width:86%" colspan="1">
                                         <img id="grdSTDResult_ctl02_Image1" class="schoollogo" src="../BranchPanel/images/admitcardheader.jpg" style="height:100px;width:100%;border-width:0px;">
                                    </td>
                                ...
                                <tr>
                                   <td style="text-align: left; border: none;width:100%" colspan="3">
                                         <img id="grdSTDResult_ctl02_Image3" class="schoollogo" src="../Branchpanel/images/admitcard.jpg" style="height:35px;width:100%;border-width:0px;">
                                    </td>
                                </tr>
                            ...
                            <table style="width: 100%; border: none;margin-bottom:8px;font-weight:bold;font-size:14px;">
                                <tbody><tr style="background-color: #3f9306;height: 25px;">
                                    ...
                                    <td style="border: none; width: 12%">Session 2019-20</td>
                                ...
                                <tr style="display:none">
                                 ...
                                 <tr>
                                    <td colspan="7" style="width: 100%; border: none;">
										...
										<center><b>ANNUAL EXAM-2019-20</b3></center>
                                          <tr>
                                    ...
                                    <td colspan="8" style="width: 100%; border: none; line-height: 25px;">
                                        ...
                                        <table style="width: 100%; font-size: 16px; border: none">
                                            ...
                                            <tr>
                                                ...
                                                <td style="border: none; width: 70%; float: right">Signature of Principal</td>
                            ...
                            <input type="button" value="Print" onclick="window.print();" style="float:right; margin: 20px 0 0 0;" />
                        </div>
                        <br />
                    </ItemTemplate>
                </asp:TemplateField>
