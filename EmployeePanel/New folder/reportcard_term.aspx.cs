        ...
        if (dtExam.Rows.Count > mm)
        {
            ...
            if (dtSubject.Rows.Count > 0)
            {
                ...
                if (dtMarks.Rows.Count > 0)
                {
                    ...
                    //Table start.
                    html.Append("<table border = '10' Style='width: 100%; font-size: 12px;'>");
                    //Building the Header row.
                    html.Append("<tr>");
                    html.Append("<th style='Width:754px; text-align: center; font-size: 12px;font-weight:bold; line-height: 30px;'>");
                    html.Append("");
                    html.Append("</th>");
                    html.Append("<th style='Width:684px; text-align: center; font-size: 12px;font-weight:bold; line-height: 30px;'>");
