            ...
            <Columns>
                <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                    ...
                    <ItemTemplate>
                        ...
                        <div style="width: 760px; height: 1080px; border: solid 12px black; padding: 10px 10px 10px 10px;">
                            ...
                            <table style="width: 100%; border: none">
                                ...
                                <tr>
                                    <td colspan="8" style="width: 100%; border: none; line-height: 20px;">
                                        ...
                                        <table style="width: 100%; font-size: 14px;font-weight:bold;">
                                            <tr>
                                                <td style="width: 53%"><b>Subjects</b></td>
                                ...
                                <tr>
                                    <td colspan="8" style="width: 120%; border: none; line-height: 25px;">
